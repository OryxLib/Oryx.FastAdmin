...
# zh-sina-a
zh_sian_hq_nodes = "http://vip.stock.finance.sina.com.cn/quotes_service/api/json_v2.php/Market_Center.getHQNodes"
zh_sina_a_stock_url = "http://vip.stock.finance.sina.com.cn/quotes_service/api/json_v2.php/Market_Center.getHQNodeData?sort=symbol&asc=1&node={}"
zh_sina_a_stock_bypage_url = "http://vip.stock.finance.sina.com.cn/quotes_service/api/json_v2.php/Market_Center.getHQNodeData?page={}&num={}&sort=symbol&asc=1&node=chgn_700867&symbol=&_s_r_a=init"
zh_sina_a_stock_bynode_count_url = "http://vip.stock.finance.sina.com.cn/quotes_service/api/json_v2.php/Market_Center.getHQNodeStockCount?node={}"
...
#CN-sina-bill
zh_sina_a_stock_bill_url = "http://vip.stock.finance.sina.com.cn/quotes_service/api/json_v2.php/CN_Bill.GetBillListCount?symbol={0}&num={1}&page={2}&sort=ticktime&asc=0&volume={3}&type=0&day={4}"
zh_sina_a_stock_bill_bySymbol_url = "http://vip.stock.finance.sina.com.cn/quotes_service/api/json_v2.php/CN_Bill.GetBillListCount?symbol={0}&num={1}&page={2}&sort=ticktime&asc=0&volume={3}&type=0&day={4}"
zh_sina_a_stock_bigbill_url =  "http://vip.stock.finance.sina.com.cn/quotes_service/api/json_v2.php/CN_Bill.GetBillListCount?symbol={0}&num={1}&page={2}&sort=ticktime&asc=0&volume={3}&type=0&day={4}"
zh_sina_a_stock_bill_count_url = "http://vip.stock.finance.sina.com.cn/quotes_service/api/json_v2.php/CN_Bill.GetBillListCount?symbol={0}&num={1}&page={2}&sort=ticktime&asc=0&volume={3}&type=0&day={4}"
zh_sina_a_stock_bill_bySymbol_count_url = "http://vip.stock.finance.sina.com.cn/quotes_service/api/json_v2.php/CN_Bill.GetBillListCount?symbol={0}&num={1}&page={2}&sort=ticktime&asc=0&volume={3}&type=0&day={4}"
