...
{
    public class QueryDeviceEventDataRequest : RpcAcsRequest<QueryDeviceEventDataResponse>
    {
        ...
        public override QueryDeviceEventDataResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryDeviceEventDataResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
