...
{
    public class CreateProductTagsRequest : RpcAcsRequest<CreateProductTagsResponse>
    {
        public CreateProductTagsRequest()
            : base("Iot", "2018-01-20", "CreateProductTags", "iot", "openAPI")
        {
        ...
        public override CreateProductTagsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateProductTagsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
