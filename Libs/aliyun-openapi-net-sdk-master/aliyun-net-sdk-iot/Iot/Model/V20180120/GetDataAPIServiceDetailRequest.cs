...
namespace Aliyun.Acs.Iot.Model.V20180120
{
    public class GetDataAPIServiceDetailRequest : RpcAcsRequest<GetDataAPIServiceDetailResponse>
    {
        ...
        public override GetDataAPIServiceDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDataAPIServiceDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
