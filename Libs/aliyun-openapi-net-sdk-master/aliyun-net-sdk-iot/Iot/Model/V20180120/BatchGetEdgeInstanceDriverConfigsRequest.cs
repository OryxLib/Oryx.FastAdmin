...
namespace Aliyun.Acs.Iot.Model.V20180120
{
    public class BatchGetEdgeInstanceDriverConfigsRequest : RpcAcsRequest<BatchGetEdgeInstanceDriverConfigsResponse>
    {
        ...
        public override BatchGetEdgeInstanceDriverConfigsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BatchGetEdgeInstanceDriverConfigsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
