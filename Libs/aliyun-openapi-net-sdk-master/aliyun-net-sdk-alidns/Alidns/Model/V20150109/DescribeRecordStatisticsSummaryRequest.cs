...
namespace Aliyun.Acs.Alidns.Model.V20150109
{
    public class DescribeRecordStatisticsSummaryRequest : RpcAcsRequest<DescribeRecordStatisticsSummaryResponse>
    {
        ...
        public override DescribeRecordStatisticsSummaryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeRecordStatisticsSummaryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
