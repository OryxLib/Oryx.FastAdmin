...
{
    public class UpdateCustomLineRequest : RpcAcsRequest<UpdateCustomLineResponse>
    {
        public UpdateCustomLineRequest()
            : base("Alidns", "2015-01-09", "UpdateCustomLine", "alidns", "openAPI")
        {
        ...
        public override UpdateCustomLineResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateCustomLineResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
