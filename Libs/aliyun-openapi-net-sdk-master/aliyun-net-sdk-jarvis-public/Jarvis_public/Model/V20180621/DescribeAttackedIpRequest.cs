...
namespace Aliyun.Acs.jarvis_public.Model.V20180621
{
    public class DescribeAttackedIpRequest : RpcAcsRequest<DescribeAttackedIpResponse>
    {
        ...
        public override DescribeAttackedIpResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAttackedIpResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
