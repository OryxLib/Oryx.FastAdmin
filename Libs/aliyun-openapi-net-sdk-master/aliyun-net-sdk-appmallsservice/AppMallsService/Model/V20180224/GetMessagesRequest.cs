...
{
    public class GetMessagesRequest : RpcAcsRequest<GetMessagesResponse>
    {
        public GetMessagesRequest()
            : base("AppMallsService", "2018-02-24", "GetMessages")
        {
        ...
        public override GetMessagesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetMessagesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
