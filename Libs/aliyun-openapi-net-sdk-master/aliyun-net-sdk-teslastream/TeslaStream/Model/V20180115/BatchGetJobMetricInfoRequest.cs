...
namespace Aliyun.Acs.TeslaStream.Model.V20180115
{
    public class BatchGetJobMetricInfoRequest : RpcAcsRequest<BatchGetJobMetricInfoResponse>
    {
		...
		public string JobInfos
		{
			...
			{
				jobInfos = value;
				DictionaryUtil.Add(QueryParameters, "JobInfos", value);
			}
		}
        ...
        public override BatchGetJobMetricInfoResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return BatchGetJobMetricInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}