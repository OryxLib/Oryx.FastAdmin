...
namespace Aliyun.Acs.TeslaStream.Model.V20180115
{
    public class BatchGetPluginConfigInfoRequest : RpcAcsRequest<BatchGetPluginConfigInfoResponse>
    {
		...
		public string PluginInfos
		{
			...
			{
				pluginInfos = value;
				DictionaryUtil.Add(QueryParameters, "PluginInfos", value);
			}
		}
        ...
        public override BatchGetPluginConfigInfoResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return BatchGetPluginConfigInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}