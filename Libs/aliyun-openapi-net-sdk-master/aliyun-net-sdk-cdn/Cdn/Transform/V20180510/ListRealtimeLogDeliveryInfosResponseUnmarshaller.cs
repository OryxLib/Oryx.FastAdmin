...
namespace Aliyun.Acs.Cdn.Transform.V20180510
{
    ...
    {
        public static ListRealtimeLogDeliveryInfosResponse Unmarshall(UnmarshallerContext context)
        {
			ListRealtimeLogDeliveryInfosResponse listRealtimeLogDeliveryInfosResponse = new ListRealtimeLogDeliveryInfosResponse();

			listRealtimeLogDeliveryInfosResponse.HttpResponse = context.HttpResponse;
			listRealtimeLogDeliveryInfosResponse.RequestId = context.StringValue("ListRealtimeLogDeliveryInfos.RequestId");
			...
			for (int i = 0; i < context.Length("ListRealtimeLogDeliveryInfos.Content.Length"); i++) {
				...
				realtimeLogDeliveryInfos.Project = context.StringValue("ListRealtimeLogDeliveryInfos.Content["+ i +"].Project");
				realtimeLogDeliveryInfos.Logstore = context.StringValue("ListRealtimeLogDeliveryInfos.Content["+ i +"].Logstore");
				realtimeLogDeliveryInfos.Region = context.StringValue("ListRealtimeLogDeliveryInfos.Content["+ i +"].Region");
