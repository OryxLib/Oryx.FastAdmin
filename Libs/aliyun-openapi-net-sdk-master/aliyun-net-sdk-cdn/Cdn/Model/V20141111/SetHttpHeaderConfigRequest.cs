...
namespace Aliyun.Acs.Cdn.Model.V20141111
{
    public class SetHttpHeaderConfigRequest : RpcAcsRequest<SetHttpHeaderConfigResponse>
    {
        public SetHttpHeaderConfigRequest()
            : base("Cdn", "2014-11-11", "SetHttpHeaderConfig")
        {
        ...
        public override SetHttpHeaderConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SetHttpHeaderConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
