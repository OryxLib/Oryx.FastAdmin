...
namespace Aliyun.Acs.Cdn.Model.V20141111
{
    public class DeleteSpecificConfigRequest : RpcAcsRequest<DeleteSpecificConfigResponse>
    {
        public DeleteSpecificConfigRequest()
            : base("Cdn", "2014-11-11", "DeleteSpecificConfig")
        {
        ...
        public override DeleteSpecificConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteSpecificConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
