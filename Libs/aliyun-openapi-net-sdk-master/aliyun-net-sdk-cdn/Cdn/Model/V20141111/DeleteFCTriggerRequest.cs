...
{
    public class DeleteFCTriggerRequest : RpcAcsRequest<DeleteFCTriggerResponse>
    {
        public DeleteFCTriggerRequest()
            : base("Cdn", "2014-11-11", "DeleteFCTrigger")
        {
        ...
        {
            return DeleteFCTriggerResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
