...
namespace Aliyun.Acs.industry_brain.Model.V20180712
{
    public class GetIndustryInfoLineageListRequest : RpcAcsRequest<GetIndustryInfoLineageListResponse>
    {
        ...
        public override GetIndustryInfoLineageListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetIndustryInfoLineageListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
