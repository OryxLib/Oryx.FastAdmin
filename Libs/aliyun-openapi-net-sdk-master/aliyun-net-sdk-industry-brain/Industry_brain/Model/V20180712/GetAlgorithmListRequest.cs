...
namespace Aliyun.Acs.industry_brain.Model.V20180712
{
    public class GetAlgorithmListRequest : RpcAcsRequest<GetAlgorithmListResponse>
    {
        ...
        public override GetAlgorithmListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAlgorithmListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
