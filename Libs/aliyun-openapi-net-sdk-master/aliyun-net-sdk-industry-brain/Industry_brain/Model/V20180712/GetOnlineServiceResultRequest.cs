...
namespace Aliyun.Acs.industry_brain.Model.V20180712
{
    public class GetOnlineServiceResultRequest : RpcAcsRequest<GetOnlineServiceResultResponse>
    {
        ...
        public override GetOnlineServiceResultResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetOnlineServiceResultResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
