...
namespace Aliyun.Acs.industry_brain.Model.V20180712
{
    public class PostRealTimeDeviceDataRequest : RpcAcsRequest<PostRealTimeDeviceDataResponse>
    {
		...
		public string ServiceId
		{
			...
			{
				serviceId = value;
				DictionaryUtil.Add(BodyParameters, "ServiceId", value);
			}
		}
        ...
        public override PostRealTimeDeviceDataResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PostRealTimeDeviceDataResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
