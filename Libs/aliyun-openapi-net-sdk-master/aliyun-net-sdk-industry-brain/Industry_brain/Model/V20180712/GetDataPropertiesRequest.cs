...
namespace Aliyun.Acs.industry_brain.Model.V20180712
{
    public class GetDataPropertiesRequest : RpcAcsRequest<GetDataPropertiesResponse>
    {
        ...
        public override GetDataPropertiesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDataPropertiesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
