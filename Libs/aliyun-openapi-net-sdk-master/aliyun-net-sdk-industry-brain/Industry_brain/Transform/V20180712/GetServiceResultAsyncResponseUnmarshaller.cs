...
{
    public class GetServiceResultAsyncResponseUnmarshaller
    {
        public static GetServiceResultAsyncResponse Unmarshall(UnmarshallerContext context)
        {
			GetServiceResultAsyncResponse getServiceResultAsyncResponse = new GetServiceResultAsyncResponse();
