...
namespace Aliyun.Acs.Dm.Model.V20170622
{
    public class ModifyTemplateRequest : RpcAcsRequest<ModifyTemplateResponse>
    {
        public ModifyTemplateRequest()
            : base("Dm", "2017-06-22", "ModifyTemplate", "dm", "openAPI")
        {
        }
        ...
        public override ModifyTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
