...
{
    public class GetRegionListRequest : RpcAcsRequest<GetRegionListResponse>
    {
        public GetRegionListRequest()
            : base("Dm", "2017-06-22", "GetRegionList", "dm", "openAPI")
        {
        }
        ...
        public override GetRegionListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetRegionListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
