...
{
    public class GetAccountListRequest : RpcAcsRequest<GetAccountListResponse>
    {
        public GetAccountListRequest()
            : base("Dm", "2017-06-22", "GetAccountList", "dm", "openAPI")
        {
        }
        ...
        public override GetAccountListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAccountListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
