...
{
	public class SenderStatisticsByTagNameAndBatchIDResponse : AcsResponse
	{
		...
		private List<SenderStatisticsByTagNameAndBatchID_Stat> data;
		...
		public List<SenderStatisticsByTagNameAndBatchID_Stat> Data
		{
			get
			{
				return data;
		...
		public class SenderStatisticsByTagNameAndBatchID_Stat
		{
