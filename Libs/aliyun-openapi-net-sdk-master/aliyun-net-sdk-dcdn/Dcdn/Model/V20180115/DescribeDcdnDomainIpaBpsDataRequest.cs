...
{
    public class DescribeDcdnDomainIpaBpsDataRequest : RpcAcsRequest<DescribeDcdnDomainIpaBpsDataResponse>
    {
        public DescribeDcdnDomainIpaBpsDataRequest()
            : base("dcdn", "2018-01-15", "DescribeDcdnDomainIpaBpsData")
        {
        ...
        public override DescribeDcdnDomainIpaBpsDataResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDcdnDomainIpaBpsDataResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
