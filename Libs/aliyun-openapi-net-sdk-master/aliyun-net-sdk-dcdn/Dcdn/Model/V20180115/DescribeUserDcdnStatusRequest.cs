...
namespace Aliyun.Acs.dcdn.Model.V20180115
{
    public class DescribeUserDcdnStatusRequest : RpcAcsRequest<DescribeUserDcdnStatusResponse>
    {
        ...
        public override DescribeUserDcdnStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeUserDcdnStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
