...
{
	public class DescribeDcdnIpaServiceResponse : AcsResponse
	{
		...
		private List<DescribeDcdnIpaService_LockReason> operationLocks;
		...
		public List<DescribeDcdnIpaService_LockReason> OperationLocks
		{
			get
			{
		...
		public class DescribeDcdnIpaService_LockReason
		{
