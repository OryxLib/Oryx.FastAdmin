...
{
    public class AddDcdnIpaDomainRequest : RpcAcsRequest<AddDcdnIpaDomainResponse>
    {
        public AddDcdnIpaDomainRequest()
            : base("dcdn", "2018-01-15", "AddDcdnIpaDomain")
        {
        ...
        public override AddDcdnIpaDomainResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddDcdnIpaDomainResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
