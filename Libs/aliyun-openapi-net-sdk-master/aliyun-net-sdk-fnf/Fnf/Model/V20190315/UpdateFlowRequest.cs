...
{
    public class UpdateFlowRequest : RpcAcsRequest<UpdateFlowResponse>
    {
        public UpdateFlowRequest()
            : base("fnf", "2019-03-15", "UpdateFlow", "fnf", "openAPI")
        {
        ...
        public override UpdateFlowResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateFlowResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
