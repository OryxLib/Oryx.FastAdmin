...
{
    public class GetExecutionHistoryRequest : RpcAcsRequest<GetExecutionHistoryResponse>
    {
        public GetExecutionHistoryRequest()
            : base("fnf", "2019-03-15", "GetExecutionHistory", "fnf", "openAPI")
        {
        }
        ...
        public override GetExecutionHistoryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetExecutionHistoryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
