...
namespace Aliyun.Acs.fnf.Model.V20190315
{
    public class DescribeFlowRequest : RpcAcsRequest<DescribeFlowResponse>
    {
        public DescribeFlowRequest()
            : base("fnf", "2019-03-15", "DescribeFlow", "fnf", "openAPI")
        {
        }
        ...
        public override DescribeFlowResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeFlowResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
