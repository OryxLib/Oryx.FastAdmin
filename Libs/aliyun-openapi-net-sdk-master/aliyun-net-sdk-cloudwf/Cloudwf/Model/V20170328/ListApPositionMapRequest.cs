...
namespace Aliyun.Acs.cloudwf.Model.V20170328
{
    public class ListApPositionMapRequest : RpcAcsRequest<ListApPositionMapResponse>
    {
        public ListApPositionMapRequest()
            : base("cloudwf", "2017-03-28", "ListApPositionMap", "cloudwf", "openAPI")
        {
        }
        ...
        public override ListApPositionMapResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
