...
{
    public class ListApUpgradeRequest : RpcAcsRequest<ListApUpgradeResponse>
    {
        public ListApUpgradeRequest()
            : base("cloudwf", "2017-03-28", "ListApUpgrade", "cloudwf", "openAPI")
        {
        }
        ...
        public override ListApUpgradeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListApUpgradeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
