...
{
    public class ListBriefApConfigRequest : RpcAcsRequest<ListBriefApConfigResponse>
    {
        public ListBriefApConfigRequest()
            : base("cloudwf", "2017-03-28", "ListBriefApConfig", "cloudwf", "openAPI")
        {
        }

		private int? searchScan;
		...
		public int? SearchScan
		{
			...
			{
				searchScan = value;
				DictionaryUtil.Add(QueryParameters, "SearchScan", value.ToString());
			}
		}
        ...
        public override ListBriefApConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListBriefApConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
