...
{
    public class ListPortalTemplateRequest : RpcAcsRequest<ListPortalTemplateResponse>
    {
        public ListPortalTemplateRequest()
            : base("cloudwf", "2017-03-28", "ListPortalTemplate", "cloudwf", "openAPI")
        {
        }
        ...
        public override ListPortalTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListPortalTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
