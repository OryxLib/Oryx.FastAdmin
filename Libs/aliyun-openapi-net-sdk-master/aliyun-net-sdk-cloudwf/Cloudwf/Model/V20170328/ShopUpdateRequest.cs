...
{
    public class ShopUpdateRequest : RpcAcsRequest<ShopUpdateResponse>
    {
        public ShopUpdateRequest()
            : base("cloudwf", "2017-03-28", "ShopUpdate", "cloudwf", "openAPI")
        {
        }
        ...
        public override ShopUpdateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ShopUpdateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
