...
namespace Aliyun.Acs.cloudwf.Model.V20170328
{
    public class GetOnlineStaTimeSerRequest : RpcAcsRequest<GetOnlineStaTimeSerResponse>
    {
        public GetOnlineStaTimeSerRequest()
            : base("cloudwf", "2017-03-28", "GetOnlineStaTimeSer", "cloudwf", "openAPI")
        {
        }
        ...
        public override GetOnlineStaTimeSerResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
