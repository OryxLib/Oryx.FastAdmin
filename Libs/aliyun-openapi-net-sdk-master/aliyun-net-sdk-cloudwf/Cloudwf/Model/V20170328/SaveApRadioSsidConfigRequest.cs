...
namespace Aliyun.Acs.cloudwf.Model.V20170328
{
    public class SaveApRadioSsidConfigRequest : RpcAcsRequest<SaveApRadioSsidConfigResponse>
    {
        public SaveApRadioSsidConfigRequest()
            : base("cloudwf", "2017-03-28", "SaveApRadioSsidConfig", "cloudwf", "openAPI")
        {
        }
        ...
        public override SaveApRadioSsidConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
