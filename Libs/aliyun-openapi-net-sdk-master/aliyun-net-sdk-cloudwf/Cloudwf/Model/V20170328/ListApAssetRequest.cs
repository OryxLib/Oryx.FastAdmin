...
{
    public class ListApAssetRequest : RpcAcsRequest<ListApAssetResponse>
    {
        public ListApAssetRequest()
            : base("cloudwf", "2017-03-28", "ListApAsset", "cloudwf", "openAPI")
        {
        }
		...
		public string SearchSerialNo
		{
			...
			set	
			{
				searchSerialNo = value;
				DictionaryUtil.Add(QueryParameters, "SearchSerialNo", value);
			}
		}
        ...
        public override ListApAssetResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListApAssetResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
