...
{
    public class ListAccountConfigRequest : RpcAcsRequest<ListAccountConfigResponse>
    {
        public ListAccountConfigRequest()
            : base("cloudwf", "2017-03-28", "ListAccountConfig", "cloudwf", "openAPI")
        {
        }
        ...
        public override ListAccountConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListAccountConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
