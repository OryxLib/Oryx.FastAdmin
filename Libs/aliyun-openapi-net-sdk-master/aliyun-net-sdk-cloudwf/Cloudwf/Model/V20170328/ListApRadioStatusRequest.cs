...
namespace Aliyun.Acs.cloudwf.Model.V20170328
{
    public class ListApRadioStatusRequest : RpcAcsRequest<ListApRadioStatusResponse>
    {
        public ListApRadioStatusRequest()
            : base("cloudwf", "2017-03-28", "ListApRadioStatus", "cloudwf", "openAPI")
        {
        }
        ...
        public override ListApRadioStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
