...
{
    public class GetScanProbeTimeSerRequest : RpcAcsRequest<GetScanProbeTimeSerResponse>
    {
        public GetScanProbeTimeSerRequest()
            : base("cloudwf", "2017-03-28", "GetScanProbeTimeSer", "cloudwf", "openAPI")
        {
        }
        ...
        public override GetScanProbeTimeSerResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetScanProbeTimeSerResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
