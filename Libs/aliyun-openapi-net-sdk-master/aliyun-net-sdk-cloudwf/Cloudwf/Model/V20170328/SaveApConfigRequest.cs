...
{
    public class SaveApConfigRequest : RpcAcsRequest<SaveApConfigResponse>
    {
        public SaveApConfigRequest()
            : base("cloudwf", "2017-03-28", "SaveApConfig", "cloudwf", "openAPI")
        {
        }
        ...
        public override SaveApConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SaveApConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
