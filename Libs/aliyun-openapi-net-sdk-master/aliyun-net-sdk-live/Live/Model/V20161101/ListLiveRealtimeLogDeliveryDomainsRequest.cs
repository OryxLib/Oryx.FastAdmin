...
namespace Aliyun.Acs.live.Model.V20161101
{
    public class ListLiveRealtimeLogDeliveryDomainsRequest : RpcAcsRequest<ListLiveRealtimeLogDeliveryDomainsResponse>
    {
        ...
        public override ListLiveRealtimeLogDeliveryDomainsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListLiveRealtimeLogDeliveryDomainsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
