...
{
    public class UpdateBoardCallbackRequest : RpcAcsRequest<UpdateBoardCallbackResponse>
    {
        public UpdateBoardCallbackRequest()
            : base("live", "2016-11-01", "UpdateBoardCallback", "live", "openAPI")
        {
        ...
        public override UpdateBoardCallbackResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateBoardCallbackResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
