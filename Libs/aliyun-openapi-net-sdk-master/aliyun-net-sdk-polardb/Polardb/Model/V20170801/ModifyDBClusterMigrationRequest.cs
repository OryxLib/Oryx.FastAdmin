...
{
    public class ModifyDBClusterMigrationRequest : RpcAcsRequest<ModifyDBClusterMigrationResponse>
    {
        public ModifyDBClusterMigrationRequest()
            : base("polardb", "2017-08-01", "ModifyDBClusterMigration", "polardb", "openAPI")
        {
        ...
        public override ModifyDBClusterMigrationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDBClusterMigrationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
