...
{
    public class BandStopSpeedUpRequest : RpcAcsRequest<BandStopSpeedUpResponse>
    {
        public BandStopSpeedUpRequest()
            : base("Snsuapi", "2018-07-09", "BandStopSpeedUp", "snsuapi", "openAPI")
        {
        }
        ...
        public override BandStopSpeedUpResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BandStopSpeedUpResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
