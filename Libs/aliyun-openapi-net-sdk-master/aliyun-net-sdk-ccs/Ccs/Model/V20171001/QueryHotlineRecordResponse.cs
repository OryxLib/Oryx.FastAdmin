...
{
	public class QueryHotlineRecordResponse : AcsResponse
	{
		...
		private List<QueryHotlineRecord_HotlineRecord> records;
		...
		public List<QueryHotlineRecord_HotlineRecord> Records
		{
			get
			{
				return records;
		...
		public class QueryHotlineRecord_HotlineRecord
		{
