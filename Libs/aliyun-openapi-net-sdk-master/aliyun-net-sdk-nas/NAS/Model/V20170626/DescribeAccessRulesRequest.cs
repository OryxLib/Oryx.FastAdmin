...
{
    public class DescribeAccessRulesRequest : RpcAcsRequest<DescribeAccessRulesResponse>
    {
        ...
        public override DescribeAccessRulesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAccessRulesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
