...
{
    public class DescribeMountTargetsRequest : RpcAcsRequest<DescribeMountTargetsResponse>
    {
        ...
        public override DescribeMountTargetsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeMountTargetsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
