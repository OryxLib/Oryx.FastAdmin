...
namespace Aliyun.Acs.NAS.Model.V20170626
{
    public class AddClientToBlackListRequest : RpcAcsRequest<AddClientToBlackListResponse>
    {
        ...
        public override AddClientToBlackListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddClientToBlackListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
