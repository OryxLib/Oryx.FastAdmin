...
{
    public class DescribeAccessGroupsRequest : RpcAcsRequest<DescribeAccessGroupsResponse>
    {
        ...
        public override DescribeAccessGroupsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAccessGroupsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
