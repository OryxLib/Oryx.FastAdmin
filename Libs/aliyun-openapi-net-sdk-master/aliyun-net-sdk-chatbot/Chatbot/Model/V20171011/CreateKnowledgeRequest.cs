...
namespace Aliyun.Acs.Chatbot.Model.V20171011
{
    public class CreateKnowledgeRequest : RpcAcsRequest<CreateKnowledgeResponse>
    {
        public CreateKnowledgeRequest()
            : base("Chatbot", "2017-10-11", "CreateKnowledge", "beebot", "openAPI")
        {
        ...
        public override CreateKnowledgeResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
