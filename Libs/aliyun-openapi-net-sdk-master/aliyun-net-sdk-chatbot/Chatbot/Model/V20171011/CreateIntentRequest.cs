...
{
    public class CreateIntentRequest : RpcAcsRequest<CreateIntentResponse>
    {
        public CreateIntentRequest()
            : base("Chatbot", "2017-10-11", "CreateIntent", "beebot", "openAPI")
        {
        }
        ...
        public override CreateIntentResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return CreateIntentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}