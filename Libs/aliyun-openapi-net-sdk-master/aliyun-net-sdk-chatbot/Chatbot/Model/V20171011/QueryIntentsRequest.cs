...
{
    public class QueryIntentsRequest : RpcAcsRequest<QueryIntentsResponse>
    {
        public QueryIntentsRequest()
            : base("Chatbot", "2017-10-11", "QueryIntents", "beebot", "openAPI")
        {
        }
		...
		public string IntentName
		{
			...
			{
				intentName = value;
				DictionaryUtil.Add(QueryParameters, "IntentName", value);
			}
		}
