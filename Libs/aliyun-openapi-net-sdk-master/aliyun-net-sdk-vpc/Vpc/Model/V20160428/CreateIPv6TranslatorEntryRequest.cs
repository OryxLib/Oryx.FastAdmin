...
{
    public class CreateIPv6TranslatorEntryRequest : RpcAcsRequest<CreateIPv6TranslatorEntryResponse>
    {
        public CreateIPv6TranslatorEntryRequest()
            : base("Vpc", "2016-04-28", "CreateIPv6TranslatorEntry", "vpc", "openAPI")
        {
        ...
        public override CreateIPv6TranslatorEntryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateIPv6TranslatorEntryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
