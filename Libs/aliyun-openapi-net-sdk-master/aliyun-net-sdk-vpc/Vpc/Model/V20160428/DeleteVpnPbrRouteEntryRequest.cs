...
{
    public class DeleteVpnPbrRouteEntryRequest : RpcAcsRequest<DeleteVpnPbrRouteEntryResponse>
    {
        public DeleteVpnPbrRouteEntryRequest()
            : base("Vpc", "2016-04-28", "DeleteVpnPbrRouteEntry", "vpc", "openAPI")
        {
        ...
        public override DeleteVpnPbrRouteEntryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteVpnPbrRouteEntryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
