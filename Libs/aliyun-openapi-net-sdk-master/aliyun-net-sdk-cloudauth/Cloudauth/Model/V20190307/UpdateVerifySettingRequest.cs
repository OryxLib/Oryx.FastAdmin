...
{
    public class UpdateVerifySettingRequest : RpcAcsRequest<UpdateVerifySettingResponse>
    {
        public UpdateVerifySettingRequest()
            : base("Cloudauth", "2019-03-07", "UpdateVerifySetting", "cloudauth", "openAPI")
        {
        ...
        public override UpdateVerifySettingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateVerifySettingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
