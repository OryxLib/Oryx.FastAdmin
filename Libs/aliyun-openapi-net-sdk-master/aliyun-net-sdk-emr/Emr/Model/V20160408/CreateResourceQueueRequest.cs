...
namespace Aliyun.Acs.Emr.Model.V20160408
{
    public class CreateResourceQueueRequest : RpcAcsRequest<CreateResourceQueueResponse>
    {
        ...
        public override CreateResourceQueueResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateResourceQueueResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
