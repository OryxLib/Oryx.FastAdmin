...
{
    public class MetastoreCreateKafkaTopicRequest : RpcAcsRequest<MetastoreCreateKafkaTopicResponse>
    {
        public MetastoreCreateKafkaTopicRequest()
            : base("Emr", "2016-04-08", "MetastoreCreateKafkaTopic", "emr", "openAPI")
        {
        }
        ...
        public override MetastoreCreateKafkaTopicResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return MetastoreCreateKafkaTopicResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
