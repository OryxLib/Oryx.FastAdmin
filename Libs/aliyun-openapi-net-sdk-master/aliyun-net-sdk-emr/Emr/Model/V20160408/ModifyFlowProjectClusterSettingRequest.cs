...
{
    public class ModifyFlowProjectClusterSettingRequest : RpcAcsRequest<ModifyFlowProjectClusterSettingResponse>
    {
        public ModifyFlowProjectClusterSettingRequest()
            : base("Emr", "2016-04-08", "ModifyFlowProjectClusterSetting", "emr", "openAPI")
        {
        }
        ...
        public override ModifyFlowProjectClusterSettingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyFlowProjectClusterSettingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
