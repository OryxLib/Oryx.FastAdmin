...
{
    public class CreateUserPasswordRequest : RpcAcsRequest<CreateUserPasswordResponse>
    {
        public CreateUserPasswordRequest()
            : base("Emr", "2016-04-08", "CreateUserPassword", "emr", "openAPI")
        {
        }
        ...
        public override CreateUserPasswordResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateUserPasswordResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
