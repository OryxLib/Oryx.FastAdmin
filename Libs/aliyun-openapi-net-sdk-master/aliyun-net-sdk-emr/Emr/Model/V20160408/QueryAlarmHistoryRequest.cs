...
{
    public class QueryAlarmHistoryRequest : RpcAcsRequest<QueryAlarmHistoryResponse>
    {
        ...
        public override QueryAlarmHistoryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryAlarmHistoryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
