...
{
	public class ListFlowJobResponse : AcsResponse
	{
		...
		private List<ListFlowJob_Job> jobList;
		...
		public List<ListFlowJob_Job> JobList
		{
			get
			{
				return jobList;
		...
		public class ListFlowJob_Job
		{
			...
			private List<ListFlowJob_Resource> resourceList;
			...
			public string LastInstanceDetail
			{
				...
				set	
				{
					lastInstanceDetail = value;
				}
			}

			public List<ListFlowJob_Resource> ResourceList
			{
				get
				{
					return resourceList;
			...
			public class ListFlowJob_Resource
			{
