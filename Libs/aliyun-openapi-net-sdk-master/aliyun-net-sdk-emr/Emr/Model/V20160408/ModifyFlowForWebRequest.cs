...
{
    public class ModifyFlowForWebRequest : RpcAcsRequest<ModifyFlowForWebResponse>
    {
        public ModifyFlowForWebRequest()
            : base("Emr", "2016-04-08", "ModifyFlowForWeb", "emr", "openAPI")
        {
        }
        ...
        public override ModifyFlowForWebResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyFlowForWebResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
