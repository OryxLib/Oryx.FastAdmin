...
{
    public class CreateFlowForWebRequest : RpcAcsRequest<CreateFlowForWebResponse>
    {
        public CreateFlowForWebRequest()
            : base("Emr", "2016-04-08", "CreateFlowForWeb", "emr", "openAPI")
        {
        }
		...
		public string Graph
		{
			...
			{
				graph = value;
				DictionaryUtil.Add(QueryParameters, "Graph", value);
			}
		}
        ...
        public override CreateFlowForWebResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateFlowForWebResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
