...
{
	public class ListClusterTemplatesResponse : AcsResponse
	{
		...
		private List<ListClusterTemplates_TemplateInfo> templateInfoList;
		...
		public List<ListClusterTemplates_TemplateInfo> TemplateInfoList
		{
			get
			{
		...
		public class ListClusterTemplates_TemplateInfo
		{
			...
			private List<ListClusterTemplates_Config> configList;
			...
			public List<ListClusterTemplates_BootstrapAction> BootstrapActionList
			{
				get
				{
			...
			public List<ListClusterTemplates_HostGroup> HostGroupList
			{
				get
				{
			...
			public List<ListClusterTemplates_Config> ConfigList
			{
				get
				{
					return configList;
			...
			public class ListClusterTemplates_BootstrapAction
			{
			...
			public class ListClusterTemplates_HostGroup
			{
			...
			public class ListClusterTemplates_Config
			{
