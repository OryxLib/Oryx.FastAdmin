...
{
    public class ModifyScalingTaskGroupRequest : RpcAcsRequest<ModifyScalingTaskGroupResponse>
    {
        ...
        public override ModifyScalingTaskGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyScalingTaskGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
