...
namespace Aliyun.Acs.LinkFace.Transform.V20180720
{
    public class DeleteFaceResponseUnmarshaller
    {
        public static DeleteFaceResponse Unmarshall(UnmarshallerContext context)
        {
			...
			deleteFaceResponse.Code = context.IntegerValue("DeleteFace.Code");
			deleteFaceResponse.Message = context.StringValue("DeleteFace.Message");
			deleteFaceResponse.Success = context.BooleanValue("DeleteFace.Success");
