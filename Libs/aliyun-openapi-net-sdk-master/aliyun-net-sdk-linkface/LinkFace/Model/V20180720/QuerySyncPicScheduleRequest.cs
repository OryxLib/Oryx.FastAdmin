...
{
    public class QuerySyncPicScheduleRequest : RpcAcsRequest<QuerySyncPicScheduleResponse>
    {
        public QuerySyncPicScheduleRequest()
            : base("LinkFace", "2018-07-20", "QuerySyncPicSchedule")
        {
        ...
        public override QuerySyncPicScheduleResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return QuerySyncPicScheduleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}