...
{
    public class QueryCashCouponsRequest : RpcAcsRequest<QueryCashCouponsResponse>
    {
        public QueryCashCouponsRequest()
            : base("BssOpenApi", "2017-12-14", "QueryCashCoupons")
        {
        ...
        public override QueryCashCouponsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryCashCouponsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
