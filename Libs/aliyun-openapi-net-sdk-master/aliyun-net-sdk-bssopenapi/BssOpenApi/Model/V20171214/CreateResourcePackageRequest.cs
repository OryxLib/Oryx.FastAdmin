...
{
    public class CreateResourcePackageRequest : RpcAcsRequest<CreateResourcePackageResponse>
    {
        ...
        public override CreateResourcePackageResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateResourcePackageResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
