...
namespace Aliyun.Acs.BssOpenApi.Model.V20171214
{
	public class CreateCostUnitResponse : AcsResponse
	{
		...
		public CreateCostUnit_Data Data
		{
			get
			{
				return data;
		...
		public class CreateCostUnit_Data
		{

			private List<CreateCostUnit_CostUnitDtoListItem> costUnitDtoList;

			public List<CreateCostUnit_CostUnitDtoListItem> CostUnitDtoList
			{
				get
				{
