...
{
    public class BindAxgRequest : RpcAcsRequest<BindAxgResponse>
    {
        public BindAxgRequest()
            : base("Dyplsapi", "2017-05-25", "BindAxg", "dypls", "openAPI")
        {
        ...
        public override BindAxgResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BindAxgResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
