...
{
    public class UpdateRotationPolicyRequest : RpcAcsRequest<UpdateRotationPolicyResponse>
    {
        public UpdateRotationPolicyRequest()
            : base("Kms", "2016-01-20", "UpdateRotationPolicy", "kms", "openAPI")
        {
        ...
        public override UpdateRotationPolicyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateRotationPolicyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
