...
namespace Aliyun.Acs.Kms.Model.V20160120
{
    public class EnableKeyRequest : RpcAcsRequest<EnableKeyResponse>
    {
        ...
        public override EnableKeyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnableKeyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
