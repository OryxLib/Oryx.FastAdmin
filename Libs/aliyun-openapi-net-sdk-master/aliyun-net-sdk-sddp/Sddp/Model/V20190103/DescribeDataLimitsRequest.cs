...
namespace Aliyun.Acs.Sddp.Model.V20190103
{
    public class DescribeDataLimitsRequest : RpcAcsRequest<DescribeDataLimitsResponse>
    {
        ...
        public override DescribeDataLimitsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDataLimitsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
