...
{
    public class QueryTokenForMnsQueueRequest : RpcAcsRequest<QueryTokenForMnsQueueResponse>
    {
        public QueryTokenForMnsQueueRequest()
            : base("Dybaseapi", "2017-05-25", "QueryTokenForMnsQueue", "dybaseapi", "openAPI")
        {
        }
