...
namespace Aliyun.Acs.R_kvstore.Transform.V20150101
{
    public class DescribeCacheAnalysisReportResponseUnmarshaller
    {
        public static DescribeCacheAnalysisReportResponse Unmarshall(UnmarshallerContext context)
        {
			...
			describeCacheAnalysisReportResponse.HotKeys = context.StringValue("DescribeCacheAnalysisReport.HotKeys");
			describeCacheAnalysisReportResponse.BigKeys = context.StringValue("DescribeCacheAnalysisReport.BigKeys");
