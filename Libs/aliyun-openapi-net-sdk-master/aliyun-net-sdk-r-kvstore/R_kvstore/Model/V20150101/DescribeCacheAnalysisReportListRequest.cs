...
namespace Aliyun.Acs.R_kvstore.Model.V20150101
{
    public class DescribeCacheAnalysisReportListRequest : RpcAcsRequest<DescribeCacheAnalysisReportListResponse>
    {
        ...
        public override DescribeCacheAnalysisReportListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeCacheAnalysisReportListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
