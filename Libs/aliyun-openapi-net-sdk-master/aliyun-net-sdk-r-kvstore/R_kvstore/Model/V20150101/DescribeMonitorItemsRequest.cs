...
namespace Aliyun.Acs.R_kvstore.Model.V20150101
{
    public class DescribeMonitorItemsRequest : RpcAcsRequest<DescribeMonitorItemsResponse>
    {
        ...
        public override DescribeMonitorItemsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeMonitorItemsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
