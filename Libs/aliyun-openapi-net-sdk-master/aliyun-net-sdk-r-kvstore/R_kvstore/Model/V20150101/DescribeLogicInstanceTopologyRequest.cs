...
namespace Aliyun.Acs.R_kvstore.Model.V20150101
{
    public class DescribeLogicInstanceTopologyRequest : RpcAcsRequest<DescribeLogicInstanceTopologyResponse>
    {
        public DescribeLogicInstanceTopologyRequest()
            : base("R-kvstore", "2015-01-01", "DescribeLogicInstanceTopology")
        {
        ...
        public override DescribeLogicInstanceTopologyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeLogicInstanceTopologyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
