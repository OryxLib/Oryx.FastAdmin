...
namespace Aliyun.Acs.R_kvstore.Model.V20150101
{
    public class TransformToPrePaidRequest : RpcAcsRequest<TransformToPrePaidResponse>
    {
        public TransformToPrePaidRequest()
            : base("R-kvstore", "2015-01-01", "TransformToPrePaid")
        {
        ...
        public override TransformToPrePaidResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return TransformToPrePaidResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
