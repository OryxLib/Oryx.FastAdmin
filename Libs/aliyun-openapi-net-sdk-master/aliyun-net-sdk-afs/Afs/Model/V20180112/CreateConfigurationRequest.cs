...
{
    public class CreateConfigurationRequest : RpcAcsRequest<CreateConfigurationResponse>
    {
        public CreateConfigurationRequest()
            : base("afs", "2018-01-12", "CreateConfiguration", "afs", "openAPI")
        {
        }
		...
		public string ConfigurationName
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "ConfigurationName", value);
			}
		}
		...
		public string MaxPV
		{
			...
			{
				maxPV = value;
				DictionaryUtil.Add(QueryParameters, "MaxPV", value);
			}
		}
