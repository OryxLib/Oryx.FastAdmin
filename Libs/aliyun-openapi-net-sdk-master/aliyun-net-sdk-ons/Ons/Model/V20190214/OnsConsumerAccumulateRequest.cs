...
namespace Aliyun.Acs.Ons.Model.V20190214
{
    public class OnsConsumerAccumulateRequest : RpcAcsRequest<OnsConsumerAccumulateResponse>
    {
        public OnsConsumerAccumulateRequest()
            : base("Ons", "2019-02-14", "OnsConsumerAccumulate", "ons", "openAPI")
        {
        ...
        public override OnsConsumerAccumulateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
