...
namespace Aliyun.Acs.Ons.Model.V20190214
{
    public class OnsMqttQueryClientByGroupIdRequest : RpcAcsRequest<OnsMqttQueryClientByGroupIdResponse>
    {
        public OnsMqttQueryClientByGroupIdRequest()
            : base("Ons", "2019-02-14", "OnsMqttQueryClientByGroupId", "ons", "openAPI")
        {
        ...
        public override OnsMqttQueryClientByGroupIdResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
