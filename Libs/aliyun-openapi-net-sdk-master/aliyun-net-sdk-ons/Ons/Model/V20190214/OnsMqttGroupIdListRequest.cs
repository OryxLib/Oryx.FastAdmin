...
namespace Aliyun.Acs.Ons.Model.V20190214
{
    public class OnsMqttGroupIdListRequest : RpcAcsRequest<OnsMqttGroupIdListResponse>
    {
        ...
        public override OnsMqttGroupIdListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return OnsMqttGroupIdListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
