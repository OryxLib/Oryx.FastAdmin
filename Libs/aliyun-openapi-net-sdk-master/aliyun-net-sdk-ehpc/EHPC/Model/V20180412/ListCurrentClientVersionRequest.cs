...
{
    public class ListCurrentClientVersionRequest : RpcAcsRequest<ListCurrentClientVersionResponse>
    {
        ...
        {
            return ListCurrentClientVersionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
