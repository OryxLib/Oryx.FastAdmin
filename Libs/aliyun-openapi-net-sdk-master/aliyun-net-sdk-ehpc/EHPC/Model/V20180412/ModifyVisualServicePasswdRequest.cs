...
namespace Aliyun.Acs.EHPC.Model.V20180412
{
    public class ModifyVisualServicePasswdRequest : RpcAcsRequest<ModifyVisualServicePasswdResponse>
    {
        ...
        public override ModifyVisualServicePasswdResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyVisualServicePasswdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
