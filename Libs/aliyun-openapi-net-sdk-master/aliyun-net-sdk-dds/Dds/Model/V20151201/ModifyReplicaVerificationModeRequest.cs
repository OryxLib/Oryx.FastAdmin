...
namespace Aliyun.Acs.Dds.Model.V20151201
{
    public class ModifyReplicaVerificationModeRequest : RpcAcsRequest<ModifyReplicaVerificationModeResponse>
    {
        public ModifyReplicaVerificationModeRequest()
            : base("Dds", "2015-12-01", "ModifyReplicaVerificationMode", "Dds", "openAPI")
        {
        }
        ...
        public override ModifyReplicaVerificationModeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
