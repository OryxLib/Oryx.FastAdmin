...
{
    public class ModifyReplicaModeRequest : RpcAcsRequest<ModifyReplicaModeResponse>
    {
        public ModifyReplicaModeRequest()
            : base("Dds", "2015-12-01", "ModifyReplicaMode", "Dds", "openAPI")
        {
        }
		...
		public string PrimaryInstanceId
		{
			...
			set	
			{
				primaryInstanceId = value;
				DictionaryUtil.Add(QueryParameters, "PrimaryInstanceId", value);
			}
		}
        ...
        public override ModifyReplicaModeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyReplicaModeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
