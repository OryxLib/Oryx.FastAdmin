...
namespace Aliyun.Acs.Dds.Model.V20151201
{
    public class DescribeReplicaConflictInfoRequest : RpcAcsRequest<DescribeReplicaConflictInfoResponse>
    {
        public DescribeReplicaConflictInfoRequest()
            : base("Dds", "2015-12-01", "DescribeReplicaConflictInfo", "Dds", "openAPI")
        {
        }
        ...
        public override DescribeReplicaConflictInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
