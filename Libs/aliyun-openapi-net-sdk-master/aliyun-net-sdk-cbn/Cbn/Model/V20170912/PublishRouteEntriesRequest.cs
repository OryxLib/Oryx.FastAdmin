...
{
    public class PublishRouteEntriesRequest : RpcAcsRequest<PublishRouteEntriesResponse>
    {
        public PublishRouteEntriesRequest()
            : base("Cbn", "2017-09-12", "PublishRouteEntries", "cbn", "openAPI")
        {
        }
        ...
        public override PublishRouteEntriesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PublishRouteEntriesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
