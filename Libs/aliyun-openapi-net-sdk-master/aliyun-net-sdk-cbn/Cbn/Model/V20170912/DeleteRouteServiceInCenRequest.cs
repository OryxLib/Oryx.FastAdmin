...
{
    public class DeleteRouteServiceInCenRequest : RpcAcsRequest<DeleteRouteServiceInCenResponse>
    {
        ...
        public override DeleteRouteServiceInCenResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteRouteServiceInCenResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
