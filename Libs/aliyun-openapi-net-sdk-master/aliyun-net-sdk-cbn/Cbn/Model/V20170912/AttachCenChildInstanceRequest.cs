...
{
    public class AttachCenChildInstanceRequest : RpcAcsRequest<AttachCenChildInstanceResponse>
    {
        public AttachCenChildInstanceRequest()
            : base("Cbn", "2017-09-12", "AttachCenChildInstance", "cbn", "openAPI")
        {
        }
		...
		public long? ChildInstanceOwnerId
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "ChildInstanceOwnerId", value.ToString());
			}
		}
        ...
        public override AttachCenChildInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AttachCenChildInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
