...
{
    public class AddLabelRequest : RpcAcsRequest<AddLabelResponse>
    {
        public AddLabelRequest()
            : base("Crm", "2015-04-08", "AddLabel", "crm", "openAPI")
        {
        }
        ...
        public override AddLabelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddLabelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
