...
{
    public class AddLabelForBidRequest : RpcAcsRequest<AddLabelForBidResponse>
    {
        public AddLabelForBidRequest()
            : base("Crm", "2015-04-08", "AddLabelForBid", "crm", "openAPI")
        {
        }
        ...
        public override AddLabelForBidResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddLabelForBidResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
