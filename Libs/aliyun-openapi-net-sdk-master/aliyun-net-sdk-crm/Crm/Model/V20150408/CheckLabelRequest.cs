...
{
    public class CheckLabelRequest : RpcAcsRequest<CheckLabelResponse>
    {
        public CheckLabelRequest()
            : base("Crm", "2015-04-08", "CheckLabel", "crm", "openAPI")
        {
        }
        ...
        public override CheckLabelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckLabelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
