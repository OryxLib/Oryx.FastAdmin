...
{
    public class CheckLabelForBidRequest : RpcAcsRequest<CheckLabelForBidResponse>
    {
        public CheckLabelForBidRequest()
            : base("Crm", "2015-04-08", "CheckLabelForBid", "crm", "openAPI")
        {
        }
        ...
        public override CheckLabelForBidResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckLabelForBidResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
