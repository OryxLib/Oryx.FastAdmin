...
{
    public class CreateWebSignatureRequest : RpcAcsRequest<CreateWebSignatureResponse>
    {
        public CreateWebSignatureRequest()
            : base("cas", "2018-08-13", "CreateWebSignature", "cas_esign_fdd", "openAPI")
        {
        }
        ...
        public override CreateWebSignatureResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateWebSignatureResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
