...
{
    public class AbandonStackRequest : RoaAcsRequest<AbandonStackResponse>
    {
        ...
        public override AbandonStackResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AbandonStackResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
