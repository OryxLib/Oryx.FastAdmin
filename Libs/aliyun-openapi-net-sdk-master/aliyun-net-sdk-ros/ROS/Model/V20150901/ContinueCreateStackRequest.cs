...
{
    public class ContinueCreateStackRequest : RoaAcsRequest<ContinueCreateStackResponse>
    {
        public ContinueCreateStackRequest()
            : base("ROS", "2015-09-01", "ContinueCreateStack")
        {
			...
			UriPattern = "/stacks/[StackName]/[StackId]/continue";
