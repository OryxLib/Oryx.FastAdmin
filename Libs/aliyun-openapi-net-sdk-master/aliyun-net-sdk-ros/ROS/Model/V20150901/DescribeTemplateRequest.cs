...
{
    public class DescribeTemplateRequest : RoaAcsRequest<DescribeTemplateResponse>
    {
        ...
        public override DescribeTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
