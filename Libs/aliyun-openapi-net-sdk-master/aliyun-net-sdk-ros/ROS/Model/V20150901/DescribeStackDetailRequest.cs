...
{
    public class DescribeStackDetailRequest : RoaAcsRequest<DescribeStackDetailResponse>
    {
        public DescribeStackDetailRequest()
            : base("ROS", "2015-09-01", "DescribeStackDetail")
        {
        ...
        public override DescribeStackDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeStackDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
