...
namespace Aliyun.Acs.ROS.Model.V20150901
{
    public class DescribeChangeSetDetailRequest : RoaAcsRequest<DescribeChangeSetDetailResponse>
    {
        ...
        public override DescribeChangeSetDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeChangeSetDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
