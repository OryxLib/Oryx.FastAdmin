...
{
    public class SignalResourceRequest : RpcAcsRequest<SignalResourceResponse>
    {
        public SignalResourceRequest()
            : base("ROS", "2019-09-10", "SignalResource")
        {
        ...
        public override SignalResourceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SignalResourceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
