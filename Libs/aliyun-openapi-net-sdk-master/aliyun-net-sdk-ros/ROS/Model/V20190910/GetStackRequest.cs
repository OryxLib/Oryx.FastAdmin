...
namespace Aliyun.Acs.ROS.Model.V20190910
{
    public class GetStackRequest : RpcAcsRequest<GetStackResponse>
    {
        ...
        public override GetStackResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetStackResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
