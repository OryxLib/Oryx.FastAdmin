...
namespace Aliyun.Acs.ROS.Model.V20190910
{
    public class GetResourceTypeTemplateRequest : RpcAcsRequest<GetResourceTypeTemplateResponse>
    {
        ...
        public override GetResourceTypeTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetResourceTypeTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
