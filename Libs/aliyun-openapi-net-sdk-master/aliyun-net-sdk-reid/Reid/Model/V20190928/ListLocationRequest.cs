...
namespace Aliyun.Acs.reid.Model.V20190928
{
    public class ListLocationRequest : RpcAcsRequest<ListLocationResponse>
    {
        public ListLocationRequest()
            : base("reid", "2019-09-28", "ListLocation", "1.0.0", "openAPI")
        {
        ...
        public override ListLocationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListLocationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
