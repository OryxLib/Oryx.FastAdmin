...
{
    public class DeleteMultipartUploadRequest : RpcAcsRequest<DeleteMultipartUploadResponse>
    {
        public DeleteMultipartUploadRequest()
            : base("vod", "2017-03-21", "DeleteMultipartUpload")
        {
        ...
        public override DeleteMultipartUploadResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteMultipartUploadResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
