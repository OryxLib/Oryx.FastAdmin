    ...
    public class SubmitPreprocessJobsRequest : RpcAcsRequest<SubmitPreprocessJobsResponse>
    {
		...
		public string PreprocessType
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "PreprocessType", value);
			}
		}

        public override SubmitPreprocessJobsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitPreprocessJobsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
