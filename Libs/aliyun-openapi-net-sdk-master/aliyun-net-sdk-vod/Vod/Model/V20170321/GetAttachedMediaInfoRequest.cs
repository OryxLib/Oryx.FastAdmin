...
{
    public class GetAttachedMediaInfoRequest : RpcAcsRequest<GetAttachedMediaInfoResponse>
    {
        public GetAttachedMediaInfoRequest()
            : base("vod", "2017-03-21", "GetAttachedMediaInfo")
        {
        ...
        public override GetAttachedMediaInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAttachedMediaInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
