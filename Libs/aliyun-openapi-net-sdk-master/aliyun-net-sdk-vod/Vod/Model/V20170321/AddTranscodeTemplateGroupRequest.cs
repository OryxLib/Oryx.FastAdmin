...
{
    public class AddTranscodeTemplateGroupRequest : RpcAcsRequest<AddTranscodeTemplateGroupResponse>
    {
        public AddTranscodeTemplateGroupRequest()
            : base("vod", "2017-03-21", "AddTranscodeTemplateGroup")
        {
        ...
        public override AddTranscodeTemplateGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddTranscodeTemplateGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
