...
{
	public class GetInstanceSummaryReportSinceMidnightResponse : AcsResponse
	{
		...
		private GetInstanceSummaryReportSinceMidnight_InstanceSummaryReport instanceSummaryReport;
		...
		public GetInstanceSummaryReportSinceMidnight_InstanceSummaryReport InstanceSummaryReport
		{
			get
			{
		...
		public class GetInstanceSummaryReportSinceMidnight_InstanceSummaryReport
		{
			...
			private GetInstanceSummaryReportSinceMidnight_Overall overall;

			private GetInstanceSummaryReportSinceMidnight_Inbound inbound;

			private GetInstanceSummaryReportSinceMidnight_Outbound outbound;
			...
			public GetInstanceSummaryReportSinceMidnight_Overall Overall
			{
				get
				{
					return overall;
			...
			public GetInstanceSummaryReportSinceMidnight_Inbound Inbound
			{
				get
				{
					return inbound;
			...
			public GetInstanceSummaryReportSinceMidnight_Outbound Outbound
			{
				get
				{
					return outbound;
			...
			public class GetInstanceSummaryReportSinceMidnight_Overall
			{
			...
			public class GetInstanceSummaryReportSinceMidnight_Inbound
			{
			...
			public class GetInstanceSummaryReportSinceMidnight_Outbound
			{
