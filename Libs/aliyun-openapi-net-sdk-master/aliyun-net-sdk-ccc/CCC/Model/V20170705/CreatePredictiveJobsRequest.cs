...
{
    public class CreatePredictiveJobsRequest : RpcAcsRequest<CreatePredictiveJobsResponse>
    {
        public CreatePredictiveJobsRequest()
            : base("CCC", "2017-07-05", "CreatePredictiveJobs")
        {
        ...
        public override CreatePredictiveJobsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreatePredictiveJobsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
