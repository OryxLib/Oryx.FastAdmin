...
{
    public class ModifySurveyRequest : RpcAcsRequest<ModifySurveyResponse>
    {
        public ModifySurveyRequest()
            : base("CCC", "2017-07-05", "ModifySurvey")
        {
        ...
        public override ModifySurveyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifySurveyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
