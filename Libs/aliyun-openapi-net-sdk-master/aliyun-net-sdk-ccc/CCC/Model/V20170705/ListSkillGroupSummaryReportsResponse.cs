...
{
	public class ListSkillGroupSummaryReportsResponse : AcsResponse
	{
		...
		private ListSkillGroupSummaryReports_PagedSkillGroupSummaryReport pagedSkillGroupSummaryReport;
		...
		public ListSkillGroupSummaryReports_PagedSkillGroupSummaryReport PagedSkillGroupSummaryReport
		{
			get
			{
		...
		public class ListSkillGroupSummaryReports_PagedSkillGroupSummaryReport
		{
			...
			private List<ListSkillGroupSummaryReports_SkillGroupSummaryReport> list;
			...
			public List<ListSkillGroupSummaryReports_SkillGroupSummaryReport> List
			{
				get
				{
					return list;
			...
			public class ListSkillGroupSummaryReports_SkillGroupSummaryReport
			{
				...
				private ListSkillGroupSummaryReports_Overall overall;

				private ListSkillGroupSummaryReports_Inbound inbound;

				private ListSkillGroupSummaryReports_Outbound outbound;
				...
				public ListSkillGroupSummaryReports_Overall Overall
				{
					get
					{
						return overall;
				...
				public ListSkillGroupSummaryReports_Inbound Inbound
				{
					get
					{
						return inbound;
				...
				public ListSkillGroupSummaryReports_Outbound Outbound
				{
					get
					{
						return outbound;
				...
				public class ListSkillGroupSummaryReports_Overall
				{
				...
				public class ListSkillGroupSummaryReports_Inbound
				{
				...
				public class ListSkillGroupSummaryReports_Outbound
				{
