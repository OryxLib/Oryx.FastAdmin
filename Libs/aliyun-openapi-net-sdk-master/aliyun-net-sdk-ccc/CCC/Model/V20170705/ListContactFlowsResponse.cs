...
namespace Aliyun.Acs.CCC.Model.V20170705
{
	public class ListContactFlowsResponse : AcsResponse
	{
		...
		private List<ListContactFlows_ContactFlow> contactFlows;
		...
		public List<ListContactFlows_ContactFlow> ContactFlows
		{
			get
			{
				return contactFlows;
		...
		public class ListContactFlows_ContactFlow
		{
			...
			private List<ListContactFlows_ContactFlowVersion> versions;

			private List<ListContactFlows_PhoneNumber> phoneNumbers;
			...
			public List<ListContactFlows_ContactFlowVersion> Versions
			{
				get
				{
					return versions;
			...
			public List<ListContactFlows_PhoneNumber> PhoneNumbers
			{
				get
				{
					return phoneNumbers;
			...
			public class ListContactFlows_ContactFlowVersion
			{
			...
			public class ListContactFlows_PhoneNumber
			{
