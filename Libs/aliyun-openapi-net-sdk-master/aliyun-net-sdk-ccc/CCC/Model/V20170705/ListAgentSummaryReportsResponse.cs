...
{
	public class ListAgentSummaryReportsResponse : AcsResponse
	{
		...
		private ListAgentSummaryReports_PagedAgentSummaryReport pagedAgentSummaryReport;
		...
		public ListAgentSummaryReports_PagedAgentSummaryReport PagedAgentSummaryReport
		{
			get
			{
		...
		public class ListAgentSummaryReports_PagedAgentSummaryReport
		{
			...
			private List<ListAgentSummaryReports_AgentSummaryReport> list;
			...
			public List<ListAgentSummaryReports_AgentSummaryReport> List
			{
				get
				{
					return list;
			...
			public class ListAgentSummaryReports_AgentSummaryReport
			{
				...
				private ListAgentSummaryReports_Overall overall;

				private ListAgentSummaryReports_Inbound inbound;

				private ListAgentSummaryReports_Outbound outbound;
				...
				public ListAgentSummaryReports_Overall Overall
				{
					get
					{
						return overall;
				...
				public ListAgentSummaryReports_Inbound Inbound
				{
					get
					{
						return inbound;
				...
				public ListAgentSummaryReports_Outbound Outbound
				{
					get
					{
						return outbound;
				...
				public class ListAgentSummaryReports_Overall
				{
				...
				public class ListAgentSummaryReports_Inbound
				{
				...
				public class ListAgentSummaryReports_Outbound
				{
