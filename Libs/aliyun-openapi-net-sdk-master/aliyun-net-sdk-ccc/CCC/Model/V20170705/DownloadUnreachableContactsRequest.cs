...
namespace Aliyun.Acs.CCC.Model.V20170705
{
    public class DownloadUnreachableContactsRequest : RpcAcsRequest<DownloadUnreachableContactsResponse>
    {
        public DownloadUnreachableContactsRequest()
            : base("CCC", "2017-07-05", "DownloadUnreachableContacts")
        {
        ...
        public override DownloadUnreachableContactsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
