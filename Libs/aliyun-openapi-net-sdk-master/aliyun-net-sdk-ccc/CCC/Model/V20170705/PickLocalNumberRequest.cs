...
{
    public class PickLocalNumberRequest : RpcAcsRequest<PickLocalNumberResponse>
    {
        public PickLocalNumberRequest()
            : base("CCC", "2017-07-05", "PickLocalNumber")
        {
        ...
        public override PickLocalNumberResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PickLocalNumberResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
