...
namespace Aliyun.Acs.CCC.Model.V20170705
{
    public class TwoPartiesCallRequest : RpcAcsRequest<TwoPartiesCallResponse>
    {
        ...
        public override TwoPartiesCallResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return TwoPartiesCallResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
