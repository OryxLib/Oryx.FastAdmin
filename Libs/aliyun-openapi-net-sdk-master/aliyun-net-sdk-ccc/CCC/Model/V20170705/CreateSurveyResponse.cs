...
{
	public class CreateSurveyResponse : AcsResponse
	{
		...
		private CreateSurvey_Survey survey;
		...
		public CreateSurvey_Survey Survey
		{
			get
			{
				return survey;
		...
		public class CreateSurvey_Survey
		{
			...
			private CreateSurvey_Flow flow;

			private CreateSurvey_AsrCustomModel asrCustomModel;
			...
			public CreateSurvey_AsrCustomModel AsrCustomModel
			{
				get
				{
			...
			public class CreateSurvey_Flow
			{
			...
			public class CreateSurvey_AsrCustomModel
			{
