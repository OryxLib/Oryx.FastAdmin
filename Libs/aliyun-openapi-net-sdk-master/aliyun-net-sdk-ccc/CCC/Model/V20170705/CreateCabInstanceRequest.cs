...
{
    public class CreateCabInstanceRequest : RpcAcsRequest<CreateCabInstanceResponse>
    {
        public CreateCabInstanceRequest()
            : base("CCC", "2017-07-05", "CreateCabInstance")
        {
        ...
        public override CreateCabInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateCabInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
