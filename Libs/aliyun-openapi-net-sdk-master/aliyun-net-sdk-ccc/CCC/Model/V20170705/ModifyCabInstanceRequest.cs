...
{
    public class ModifyCabInstanceRequest : RpcAcsRequest<ModifyCabInstanceResponse>
    {
        public ModifyCabInstanceRequest()
            : base("CCC", "2017-07-05", "ModifyCabInstance")
        {
        ...
        public override ModifyCabInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyCabInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
