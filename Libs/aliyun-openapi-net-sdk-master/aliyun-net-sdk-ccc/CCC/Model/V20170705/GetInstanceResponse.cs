...
namespace Aliyun.Acs.CCC.Model.V20170705
{
	public class GetInstanceResponse : AcsResponse
	{
		...
		public class GetInstance_Instance
		{
			...
			private List<GetInstance_User> admin;

			private List<GetInstance_PhoneNumber> phoneNumbers;
			...
			public List<GetInstance_User> Admin
			{
				get
				{
					return admin;
			...
			public List<GetInstance_PhoneNumber> PhoneNumbers
			{
				get
				{
					return phoneNumbers;
			...
			public class GetInstance_User
			{
				...
				private GetInstance_Detail detail;
				...
				public GetInstance_Detail Detail
				{
					get
					{
						return detail;
				...
				public class GetInstance_Detail
				{
