...
{
    public class ListPredictiveJobStatusRequest : RpcAcsRequest<ListPredictiveJobStatusResponse>
    {
        public ListPredictiveJobStatusRequest()
            : base("CCC", "2017-07-05", "ListPredictiveJobStatus")
        {
        ...
        public override ListPredictiveJobStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListPredictiveJobStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
