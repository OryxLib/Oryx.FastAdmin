...
{
    public class ModifyMediaRequest : RpcAcsRequest<ModifyMediaResponse>
    {
        public ModifyMediaRequest()
            : base("CCC", "2017-07-05", "ModifyMedia")
        {
        ...
        public override ModifyMediaResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyMediaResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
