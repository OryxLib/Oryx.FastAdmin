...
{
    public class SaveWebRTCStatsRequest : RpcAcsRequest<SaveWebRTCStatsResponse>
    {
        public SaveWebRTCStatsRequest()
            : base("CCC", "2017-07-05", "SaveWebRTCStats")
        {
        ...
        public override SaveWebRTCStatsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SaveWebRTCStatsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
