...
namespace Aliyun.Acs.CCC.Model.V20170705
{
    public class ListSkillGroupSummaryReportsSinceMidnightRequest : RpcAcsRequest<ListSkillGroupSummaryReportsSinceMidnightResponse>
    {
		...
		public string SkillGroups
		{
			...
			{
				skillGroups = value;
				DictionaryUtil.Add(QueryParameters, "SkillGroups", value);
			}
		}
        ...
        public override ListSkillGroupSummaryReportsSinceMidnightResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListSkillGroupSummaryReportsSinceMidnightResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
