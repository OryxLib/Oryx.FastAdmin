...
{
	public class GetAgentDataResponse : AcsResponse
	{
		...
		private GetAgentData_DataList dataList;
		...
		public GetAgentData_DataList DataList
		{
			get
			{
				return dataList;
		...
		public class GetAgentData_DataList
		{
			...
			private List<GetAgentData_GenerateAgentStatistic> list;
			...
			public List<GetAgentData_GenerateAgentStatistic> List
			{
				get
				{
					return list;
			...
			public class GetAgentData_GenerateAgentStatistic
			{
				...
				private GetAgentData_Inbound inbound;

				private GetAgentData_Outbound outbound;

				private GetAgentData_Overall overall;
				...
				public GetAgentData_Inbound Inbound
				{
					get
					{
						return inbound;
				...
				public GetAgentData_Outbound Outbound
				{
					get
					{
						return outbound;
				...
				public GetAgentData_Overall Overall
				{
					get
					{
						return overall;
				...
				public class GetAgentData_Inbound
				{
				...
				public class GetAgentData_Outbound
				{
				...
				public class GetAgentData_Overall
				{
