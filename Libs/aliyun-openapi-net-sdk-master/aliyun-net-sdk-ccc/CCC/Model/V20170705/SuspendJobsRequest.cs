...
{
    public class SuspendJobsRequest : RpcAcsRequest<SuspendJobsResponse>
    {
        public SuspendJobsRequest()
            : base("CCC", "2017-07-05", "SuspendJobs")
        {
        ...
        public override SuspendJobsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SuspendJobsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
