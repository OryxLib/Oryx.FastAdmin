...
{
    public class QueryTrademarkMonitorRulesRequest : RpcAcsRequest<QueryTrademarkMonitorRulesResponse>
    {
		...
		public int? NotifyUpdate
		{
			...
			{
				notifyUpdate = value;
				DictionaryUtil.Add(QueryParameters, "NotifyUpdate", value.ToString());
			}
		}
        ...
        public override QueryTrademarkMonitorRulesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryTrademarkMonitorRulesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
