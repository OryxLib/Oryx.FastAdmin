...
{
    public class QueryMaterialRequest : RpcAcsRequest<QueryMaterialResponse>
    {
        ...
        public override QueryMaterialResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryMaterialResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
