...
{
    public class QueryMaterialListRequest : RpcAcsRequest<QueryMaterialListResponse>
    {
        ...
        public override QueryMaterialListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryMaterialListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
