...
{
    public class InsertMaterialRequest : RpcAcsRequest<InsertMaterialResponse>
    {
        public InsertMaterialRequest()
            : base("Trademark", "2018-07-24", "InsertMaterial", "trademark", "openAPI")
        {
        }
        ...
        public override InsertMaterialResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InsertMaterialResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
