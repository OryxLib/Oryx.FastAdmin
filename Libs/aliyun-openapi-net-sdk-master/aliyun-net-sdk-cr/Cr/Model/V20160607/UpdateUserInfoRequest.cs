...
namespace Aliyun.Acs.cr.Model.V20160607
{
    public class UpdateUserInfoRequest : RoaAcsRequest<UpdateUserInfoResponse>
    {
        ...
        public override UpdateUserInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateUserInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
