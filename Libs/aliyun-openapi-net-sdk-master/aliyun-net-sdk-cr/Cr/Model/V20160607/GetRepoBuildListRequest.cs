...
{
    public class GetRepoBuildListRequest : RoaAcsRequest<GetRepoBuildListResponse>
    {
        public GetRepoBuildListRequest()
            : base("cr", "2016-06-07", "GetRepoBuildList", "cr", "openAPI")
        {
        ...
        public override GetRepoBuildListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetRepoBuildListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
