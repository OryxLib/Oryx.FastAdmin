...
{
    public class GetRepoBuildRuleListRequest : RoaAcsRequest<GetRepoBuildRuleListResponse>
    {
        ...
        public override GetRepoBuildRuleListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetRepoBuildRuleListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
