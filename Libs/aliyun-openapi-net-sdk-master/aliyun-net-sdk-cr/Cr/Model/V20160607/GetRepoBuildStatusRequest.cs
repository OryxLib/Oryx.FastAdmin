...
namespace Aliyun.Acs.cr.Model.V20160607
{
    public class GetRepoBuildStatusRequest : RoaAcsRequest<GetRepoBuildStatusResponse>
    {
        ...
        public override GetRepoBuildStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetRepoBuildStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
