...
{
    public class UpdateRepoRequest : RoaAcsRequest<UpdateRepoResponse>
    {
        public UpdateRepoRequest()
            : base("cr", "2016-06-07", "UpdateRepo", "cr", "openAPI")
        {
        ...
        public override UpdateRepoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateRepoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
