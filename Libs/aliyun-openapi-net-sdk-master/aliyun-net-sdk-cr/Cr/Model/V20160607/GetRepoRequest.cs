...
{
    public class GetRepoRequest : RoaAcsRequest<GetRepoResponse>
    {
        public GetRepoRequest()
            : base("cr", "2016-06-07", "GetRepo", "cr", "openAPI")
        {
        ...
        public override GetRepoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetRepoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
