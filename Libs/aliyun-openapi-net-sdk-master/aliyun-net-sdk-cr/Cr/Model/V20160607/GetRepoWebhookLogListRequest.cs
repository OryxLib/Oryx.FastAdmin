...
{
    public class GetRepoWebhookLogListRequest : RoaAcsRequest<GetRepoWebhookLogListResponse>
    {
        public GetRepoWebhookLogListRequest()
            : base("cr", "2016-06-07", "GetRepoWebhookLogList", "cr", "openAPI")
        {
        ...
        public override GetRepoWebhookLogListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetRepoWebhookLogListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
