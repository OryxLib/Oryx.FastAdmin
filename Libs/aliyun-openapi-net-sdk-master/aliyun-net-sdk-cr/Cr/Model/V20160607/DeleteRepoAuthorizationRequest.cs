...
{
    public class DeleteRepoAuthorizationRequest : RoaAcsRequest<DeleteRepoAuthorizationResponse>
    {
        public DeleteRepoAuthorizationRequest()
            : base("cr", "2016-06-07", "DeleteRepoAuthorization", "cr", "openAPI")
        {
        ...
        public override DeleteRepoAuthorizationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteRepoAuthorizationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
