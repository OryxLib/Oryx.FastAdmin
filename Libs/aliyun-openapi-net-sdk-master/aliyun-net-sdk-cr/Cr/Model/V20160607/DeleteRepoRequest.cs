...
{
    public class DeleteRepoRequest : RoaAcsRequest<DeleteRepoResponse>
    {
        public DeleteRepoRequest()
            : base("cr", "2016-06-07", "DeleteRepo", "cr", "openAPI")
        {
        ...
        public override DeleteRepoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteRepoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
