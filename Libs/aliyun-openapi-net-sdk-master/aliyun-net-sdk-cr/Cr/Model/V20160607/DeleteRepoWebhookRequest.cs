...
namespace Aliyun.Acs.cr.Model.V20160607
{
    public class DeleteRepoWebhookRequest : RoaAcsRequest<DeleteRepoWebhookResponse>
    {
        ...
        public override DeleteRepoWebhookResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteRepoWebhookResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
