...
{
    public class GetImageScanRequest : RoaAcsRequest<GetImageScanResponse>
    {
        public GetImageScanRequest()
            : base("cr", "2016-06-07", "GetImageScan", "cr", "openAPI")
        {
        ...
        public override GetImageScanResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetImageScanResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
