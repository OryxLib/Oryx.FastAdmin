...
{
    public class DeleteRepoBuildRuleRequest : RoaAcsRequest<DeleteRepoBuildRuleResponse>
    {
        public DeleteRepoBuildRuleRequest()
            : base("cr", "2016-06-07", "DeleteRepoBuildRule", "cr", "openAPI")
        {
        ...
        public override DeleteRepoBuildRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteRepoBuildRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
