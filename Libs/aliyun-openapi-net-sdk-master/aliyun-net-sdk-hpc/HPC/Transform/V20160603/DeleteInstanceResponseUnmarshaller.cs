...
namespace Aliyun.Acs.HPC.Transform.V20160603
{
    public class DeleteInstanceResponseUnmarshaller
    {
        public static DeleteInstanceResponse Unmarshall(UnmarshallerContext context)
        {
			...
			deleteInstanceResponse.InstanceId = context.StringValue("DeleteInstance.InstanceId");
			deleteInstanceResponse.RegionId = context.StringValue("DeleteInstance.RegionId");
