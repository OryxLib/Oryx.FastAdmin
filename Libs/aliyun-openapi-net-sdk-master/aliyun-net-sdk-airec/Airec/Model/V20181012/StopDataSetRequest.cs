...
{
    public class StopDataSetRequest : RoaAcsRequest<StopDataSetResponse>
    {
        ...
        public override StopDataSetResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopDataSetResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
