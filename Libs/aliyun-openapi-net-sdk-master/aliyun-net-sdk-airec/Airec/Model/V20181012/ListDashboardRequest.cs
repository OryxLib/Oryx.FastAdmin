...
{
    public class ListDashboardRequest : RoaAcsRequest<ListDashboardResponse>
    {
        public ListDashboardRequest()
            : base("Airec", "2018-10-12", "ListDashboard", "airec", "openAPI")
        {
			UriPattern = "/openapi/instances/[InstanceId]/dashboard/statistics";
        ...
        public override ListDashboardResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDashboardResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
