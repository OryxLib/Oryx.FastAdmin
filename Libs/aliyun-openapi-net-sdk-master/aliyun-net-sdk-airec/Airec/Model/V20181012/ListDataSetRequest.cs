...
{
    public class ListDataSetRequest : RoaAcsRequest<ListDataSetResponse>
    {
        public ListDataSetRequest()
            : base("Airec", "2018-10-12", "ListDataSet", "airec", "openAPI")
        {
			UriPattern = "/openapi/instances/[InstanceId]/dataSets";
