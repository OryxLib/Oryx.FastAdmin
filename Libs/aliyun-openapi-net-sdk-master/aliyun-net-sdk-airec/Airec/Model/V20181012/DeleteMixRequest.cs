...
{
    public class DeleteMixRequest : RoaAcsRequest<DeleteMixResponse>
    {
        public DeleteMixRequest()
            : base("Airec", "2018-10-12", "DeleteMix", "airec", "openAPI")
        {
        ...
        public override DeleteMixResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteMixResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
