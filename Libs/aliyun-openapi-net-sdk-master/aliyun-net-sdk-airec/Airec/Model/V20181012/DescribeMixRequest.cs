...
{
    public class DescribeMixRequest : RoaAcsRequest<DescribeMixResponse>
    {
        public DescribeMixRequest()
            : base("Airec", "2018-10-12", "DescribeMix", "airec", "openAPI")
        {
        ...
        public override DescribeMixResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeMixResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
