...
{
    public class SetInstancesProtectionRequest : RpcAcsRequest<SetInstancesProtectionResponse>
    {
		...
		public bool? ProtectedFromScaleIn
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "ProtectedFromScaleIn", value.ToString());
			}
		}

        public override SetInstancesProtectionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SetInstancesProtectionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
