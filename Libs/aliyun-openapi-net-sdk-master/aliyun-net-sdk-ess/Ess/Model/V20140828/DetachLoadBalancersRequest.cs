...
{
    public class DetachLoadBalancersRequest : RpcAcsRequest<DetachLoadBalancersResponse>
    {
        public DetachLoadBalancersRequest()
            : base("Ess", "2014-08-28", "DetachLoadBalancers", "ess", "openAPI")
        {
        }
        ...
        public override DetachLoadBalancersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetachLoadBalancersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
