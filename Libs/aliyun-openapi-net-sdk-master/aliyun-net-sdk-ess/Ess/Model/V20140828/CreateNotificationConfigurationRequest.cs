...
{
    public class CreateNotificationConfigurationRequest : RpcAcsRequest<CreateNotificationConfigurationResponse>
    {
        ...
        public override CreateNotificationConfigurationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateNotificationConfigurationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
