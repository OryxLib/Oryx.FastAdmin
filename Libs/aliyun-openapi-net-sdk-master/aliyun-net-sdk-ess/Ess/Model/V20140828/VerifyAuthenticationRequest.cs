...
namespace Aliyun.Acs.Ess.Model.V20140828
{
    public class VerifyAuthenticationRequest : RpcAcsRequest<VerifyAuthenticationResponse>
    {
        ...
        public override VerifyAuthenticationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return VerifyAuthenticationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
