...
namespace Aliyun.Acs.Ess.Model.V20140828
{
    public class DeleteLifecycleHookRequest : RpcAcsRequest<DeleteLifecycleHookResponse>
    {
        ...
        public override DeleteLifecycleHookResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteLifecycleHookResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
