...
{
    public class OperateUserRequest : RpcAcsRequest<OperateUserResponse>
    {
        public OperateUserRequest()
            : base("Baas", "2018-07-31", "OperateUser")
        {
        }
        ...
        public override OperateUserResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OperateUserResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}