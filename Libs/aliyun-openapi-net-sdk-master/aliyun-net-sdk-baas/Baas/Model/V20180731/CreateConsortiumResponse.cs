...
{
	public class CreateConsortiumResponse : AcsResponse
	{
		...
		private CreateConsortium_Result result;
		...
		public CreateConsortium_Result Result
		{
			get
			{
				return result;
		...
		public class CreateConsortium_Result
		{
