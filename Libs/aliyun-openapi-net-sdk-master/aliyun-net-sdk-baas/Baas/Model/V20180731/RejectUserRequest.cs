...
{
    public class RejectUserRequest : RpcAcsRequest<RejectUserResponse>
    {
        public RejectUserRequest()
            : base("Baas", "2018-07-31", "RejectUser")
        {
        }
        ...
        public override RejectUserResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return RejectUserResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}