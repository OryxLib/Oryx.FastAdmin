...
{
    public class UpgradeChaincodeRequest : RpcAcsRequest<UpgradeChaincodeResponse>
    {
        public UpgradeChaincodeRequest()
            : base("Baas", "2018-07-31", "UpgradeChaincode")
        {
        }
        ...
        public override UpgradeChaincodeResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return UpgradeChaincodeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}