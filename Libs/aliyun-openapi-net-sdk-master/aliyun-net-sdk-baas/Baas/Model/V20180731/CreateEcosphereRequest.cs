...
{
    public class CreateEcosphereRequest : RpcAcsRequest<CreateEcosphereResponse>
    {
        public CreateEcosphereRequest()
            : base("Baas", "2018-07-31", "CreateEcosphere")
        {
        }
		...
		public string ConsortiumName
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(BodyParameters, "ConsortiumName", value);
			}
		}
		...
		public List<Organization> Organizations
		{
			...
			set
			{
				...
				{
					DictionaryUtil.Add(BodyParameters,"Organization." + (i + 1) + ".Domain", organizations[i].Domain);
					DictionaryUtil.Add(BodyParameters,"Organization." + (i + 1) + ".Name", organizations[i].Name);
					DictionaryUtil.Add(BodyParameters,"Organization." + (i + 1) + ".Description", organizations[i].Description);
				}
			}
		}
		...
		public string OrdererDomain
		{
			...
			{
				ordererDomain = value;
				DictionaryUtil.Add(BodyParameters, "OrdererDomain", value);
			}
		}
        ...
        public override CreateEcosphereResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return CreateEcosphereResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}