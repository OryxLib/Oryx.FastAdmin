...
{
    public class DescribeAppliesRequest : RpcAcsRequest<DescribeAppliesResponse>
    {
        public DescribeAppliesRequest()
            : base("Baas", "2018-07-31", "DescribeApplies")
        {
        }
        ...
        public override DescribeAppliesResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return DescribeAppliesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}