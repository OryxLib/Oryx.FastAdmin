...
{
    public class DescribeSagOnlineClientStatisticsRequest : RpcAcsRequest<DescribeSagOnlineClientStatisticsResponse>
    {
        ...
        public override DescribeSagOnlineClientStatisticsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSagOnlineClientStatisticsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
