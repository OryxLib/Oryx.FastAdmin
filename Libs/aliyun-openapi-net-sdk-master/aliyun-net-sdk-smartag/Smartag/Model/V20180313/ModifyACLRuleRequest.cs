...
{
    public class ModifyACLRuleRequest : RpcAcsRequest<ModifyACLRuleResponse>
    {
		...
		public string AcrId
		{
			...
			{
				acrId = value;
				DictionaryUtil.Add(QueryParameters, "AcrId", value);
			}
		}
        ...
        public override ModifyACLRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyACLRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
