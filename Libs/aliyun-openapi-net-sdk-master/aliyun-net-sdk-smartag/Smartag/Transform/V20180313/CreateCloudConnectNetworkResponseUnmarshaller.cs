...
namespace Aliyun.Acs.Smartag.Transform.V20180313
{
    ...
    {
        public static CreateCloudConnectNetworkResponse Unmarshall(UnmarshallerContext context)
        {
			CreateCloudConnectNetworkResponse createCloudConnectNetworkResponse = new CreateCloudConnectNetworkResponse();

			createCloudConnectNetworkResponse.HttpResponse = context.HttpResponse;
			createCloudConnectNetworkResponse.RequestId = context.StringValue("CreateCloudConnectNetwork.RequestId");
			createCloudConnectNetworkResponse.CcnId = context.StringValue("CreateCloudConnectNetwork.CcnId");
