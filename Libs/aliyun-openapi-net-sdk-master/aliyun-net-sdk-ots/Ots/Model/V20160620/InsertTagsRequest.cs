...
{
    public class InsertTagsRequest : RpcAcsRequest<InsertTagsResponse>
    {
        public InsertTagsRequest()
            : base("Ots", "2016-06-20", "InsertTags", "ots", "openAPI")
        {
        ...
        public override InsertTagsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InsertTagsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
