...
{
    public class UnassignPrivateIpAddressesRequest : RpcAcsRequest<UnassignPrivateIpAddressesResponse>
    {
        public UnassignPrivateIpAddressesRequest()
            : base("Ecs", "2014-05-26", "UnassignPrivateIpAddresses", "ecs", "openAPI")
        {
        ...
        public override UnassignPrivateIpAddressesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UnassignPrivateIpAddressesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
