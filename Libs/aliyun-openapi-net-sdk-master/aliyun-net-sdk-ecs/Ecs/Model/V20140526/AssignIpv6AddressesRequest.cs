...
{
    public class AssignIpv6AddressesRequest : RpcAcsRequest<AssignIpv6AddressesResponse>
    {
        public AssignIpv6AddressesRequest()
            : base("Ecs", "2014-05-26", "AssignIpv6Addresses", "ecs", "openAPI")
        {
        ...
        public override AssignIpv6AddressesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AssignIpv6AddressesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
