...
namespace Aliyun.Acs.Mts.Model.V20140618
{
    public class ReportVideoSplitJobResultRequest : RpcAcsRequest<ReportVideoSplitJobResultResponse>
    {
        ...
        public override ReportVideoSplitJobResultResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReportVideoSplitJobResultResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
