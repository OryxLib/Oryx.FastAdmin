...
{
    public class SubmitPornJobRequest : RpcAcsRequest<SubmitPornJobResponse>
    {
        ...
        public override SubmitPornJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitPornJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
