...
namespace Aliyun.Acs.Mts.Model.V20140618
{
    public class PlayerAuthRequest : RpcAcsRequest<PlayerAuthResponse>
    {
        ...
        public override PlayerAuthResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PlayerAuthResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
