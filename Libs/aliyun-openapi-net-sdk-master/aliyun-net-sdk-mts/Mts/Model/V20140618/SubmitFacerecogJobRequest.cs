...
namespace Aliyun.Acs.Mts.Model.V20140618
{
    public class SubmitFacerecogJobRequest : RpcAcsRequest<SubmitFacerecogJobResponse>
    {
		...
		private string facerecogConfig;
		...
		public string FacerecogConfig
		{
			get
			{
				return facerecogConfig;
			}
			set	
			{
				facerecogConfig = value;
				DictionaryUtil.Add(QueryParameters, "FacerecogConfig", value);
			}
		}
        ...
        public override SubmitFacerecogJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitFacerecogJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
