...
{
    public class UpdateWaterMarkTemplateRequest : RpcAcsRequest<UpdateWaterMarkTemplateResponse>
    {
        ...
        public override UpdateWaterMarkTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateWaterMarkTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
