...
namespace Aliyun.Acs.Mts.Model.V20140618
{
    public class QueryWaterMarkTemplateListRequest : RpcAcsRequest<QueryWaterMarkTemplateListResponse>
    {
		...
		public string WaterMarkTemplateIds
		{
			...
			set	
			{
				waterMarkTemplateIds = value;
				DictionaryUtil.Add(QueryParameters, "WaterMarkTemplateIds", value);
			}
		}

        public override QueryWaterMarkTemplateListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryWaterMarkTemplateListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
