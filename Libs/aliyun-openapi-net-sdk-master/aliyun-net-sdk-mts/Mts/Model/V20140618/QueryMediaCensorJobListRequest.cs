...
{
    public class QueryMediaCensorJobListRequest : RpcAcsRequest<QueryMediaCensorJobListResponse>
    {
        public QueryMediaCensorJobListRequest()
            : base("Mts", "2014-06-18", "QueryMediaCensorJobList", "mts", "openAPI")
        {
        }
        ...
        public override QueryMediaCensorJobListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryMediaCensorJobListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
