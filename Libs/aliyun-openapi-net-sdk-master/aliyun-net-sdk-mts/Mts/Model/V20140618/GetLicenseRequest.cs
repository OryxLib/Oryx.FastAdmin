...
{
    public class GetLicenseRequest : RpcAcsRequest<GetLicenseResponse>
    {
        ...
        public override GetLicenseResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetLicenseResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
