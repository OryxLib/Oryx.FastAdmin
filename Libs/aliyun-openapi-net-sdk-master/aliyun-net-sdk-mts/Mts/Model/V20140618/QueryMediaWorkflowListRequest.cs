...
namespace Aliyun.Acs.Mts.Model.V20140618
{
    public class QueryMediaWorkflowListRequest : RpcAcsRequest<QueryMediaWorkflowListResponse>
    {
		...
		public string MediaWorkflowIds
		{
			...
			set	
			{
				mediaWorkflowIds = value;
				DictionaryUtil.Add(QueryParameters, "MediaWorkflowIds", value);
			}
		}
        ...
        public override QueryMediaWorkflowListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryMediaWorkflowListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
