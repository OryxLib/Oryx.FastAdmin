...
{
    public class SubmitMCJobRequest : RpcAcsRequest<SubmitMCJobResponse>
    {
        ...
        public override SubmitMCJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitMCJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
