...
{
    public class QueryMediaCensorJobDetailRequest : RpcAcsRequest<QueryMediaCensorJobDetailResponse>
    {
        ...
        public override QueryMediaCensorJobDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryMediaCensorJobDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
