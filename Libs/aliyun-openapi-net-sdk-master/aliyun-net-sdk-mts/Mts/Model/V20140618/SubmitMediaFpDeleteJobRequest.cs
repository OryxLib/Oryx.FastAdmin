...
{
    public class SubmitMediaFpDeleteJobRequest : RpcAcsRequest<SubmitMediaFpDeleteJobResponse>
    {
        ...
        public override SubmitMediaFpDeleteJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitMediaFpDeleteJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
