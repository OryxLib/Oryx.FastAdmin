...
{
    public class UpdateAsrPipelineRequest : RpcAcsRequest<UpdateAsrPipelineResponse>
    {
        public UpdateAsrPipelineRequest()
            : base("Mts", "2014-06-18", "UpdateAsrPipeline", "mts", "openAPI")
        {
        }
        ...
        public override UpdateAsrPipelineResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateAsrPipelineResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
