...
{
    public class AddCoverPipelineRequest : RpcAcsRequest<AddCoverPipelineResponse>
    {
        ...
        public override AddCoverPipelineResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddCoverPipelineResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
