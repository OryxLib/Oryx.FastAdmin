...
namespace Aliyun.Acs.Mts.Model.V20140618
{
    public class QuerySnapshotJobListRequest : RpcAcsRequest<QuerySnapshotJobListResponse>
    {
		...
		public string SnapshotJobIds
		{
			...
			set	
			{
				snapshotJobIds = value;
				DictionaryUtil.Add(QueryParameters, "SnapshotJobIds", value);
			}
		}
        ...
        public override QuerySnapshotJobListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QuerySnapshotJobListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
