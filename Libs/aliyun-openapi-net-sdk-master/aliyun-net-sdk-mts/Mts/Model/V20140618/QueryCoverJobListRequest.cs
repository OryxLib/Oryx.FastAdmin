...
{
    public class QueryCoverJobListRequest : RpcAcsRequest<QueryCoverJobListResponse>
    {
        public QueryCoverJobListRequest()
            : base("Mts", "2014-06-18", "QueryCoverJobList", "mts", "openAPI")
        {
        }
        ...
        public override QueryCoverJobListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryCoverJobListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
