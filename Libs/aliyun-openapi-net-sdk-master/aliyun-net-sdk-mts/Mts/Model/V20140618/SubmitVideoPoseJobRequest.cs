...
{
    public class SubmitVideoPoseJobRequest : RpcAcsRequest<SubmitVideoPoseJobResponse>
    {
        ...
        public override SubmitVideoPoseJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitVideoPoseJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
