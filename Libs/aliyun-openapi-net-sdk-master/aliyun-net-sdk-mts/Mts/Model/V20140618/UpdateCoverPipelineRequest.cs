...
{
    public class UpdateCoverPipelineRequest : RpcAcsRequest<UpdateCoverPipelineResponse>
    {
        ...
        public override UpdateCoverPipelineResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateCoverPipelineResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
