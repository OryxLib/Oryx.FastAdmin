...
{
    public class SubmitTerrorismJobRequest : RpcAcsRequest<SubmitTerrorismJobResponse>
    {
        ...
        public override SubmitTerrorismJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitTerrorismJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
