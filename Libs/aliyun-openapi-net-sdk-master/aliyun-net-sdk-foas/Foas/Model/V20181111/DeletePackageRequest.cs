...
{
    public class DeletePackageRequest : RoaAcsRequest<DeletePackageResponse>
    {
        public DeletePackageRequest()
            : base("foas", "2018-11-11", "DeletePackage", "foas", "openAPI")
        {
        ...
        public override DeletePackageResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeletePackageResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
