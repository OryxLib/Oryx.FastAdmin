...
{
    public class GetInstanceRequest : RoaAcsRequest<GetInstanceResponse>
    {
        public GetInstanceRequest()
            : base("foas", "2018-11-11", "GetInstance", "foas", "openAPI")
        {
			...
			UriPattern = "/api/v2/projects/[projectName]/jobs/[jobName]/instances/[instanceId]";
