...
{
    public class ListPackageRequest : RoaAcsRequest<ListPackageResponse>
    {
        public ListPackageRequest()
            : base("foas", "2018-11-11", "ListPackage", "foas", "openAPI")
        {
        ...
        public override ListPackageResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListPackageResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
