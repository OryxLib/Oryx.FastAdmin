...
{
    public class BindQueueRequest : RoaAcsRequest<BindQueueResponse>
    {
        public BindQueueRequest()
            : base("foas", "2018-11-11", "BindQueue", "foas", "openAPI")
        {
        ...
        public override BindQueueResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BindQueueResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
