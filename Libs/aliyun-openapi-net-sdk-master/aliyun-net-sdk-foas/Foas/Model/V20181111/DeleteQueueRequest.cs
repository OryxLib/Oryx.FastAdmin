...
{
    public class DeleteQueueRequest : RoaAcsRequest<DeleteQueueResponse>
    {
        public DeleteQueueRequest()
            : base("foas", "2018-11-11", "DeleteQueue", "foas", "openAPI")
        {
        ...
        public override DeleteQueueResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteQueueResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
