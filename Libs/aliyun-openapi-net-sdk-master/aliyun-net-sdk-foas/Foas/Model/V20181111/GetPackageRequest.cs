...
{
    public class GetPackageRequest : RoaAcsRequest<GetPackageResponse>
    {
        public GetPackageRequest()
            : base("foas", "2018-11-11", "GetPackage", "foas", "openAPI")
        {
        ...
        public override GetPackageResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPackageResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
