...
{
    public class StartJobRequest : RoaAcsRequest<StartJobResponse>
    {
        public StartJobRequest()
            : base("foas", "2018-11-11", "StartJob", "foas", "openAPI")
        {
			...
			UriPattern = "/api/v2/projects/[projectName]/jobs/[jobName]/instance";
		...
		public string ParameterJson
		{
			...
			{
				parameterJson = value;
				DictionaryUtil.Add(BodyParameters, "parameterJson", value);
			}
		}
