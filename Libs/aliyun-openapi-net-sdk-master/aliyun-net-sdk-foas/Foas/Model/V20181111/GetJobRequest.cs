...
{
    public class GetJobRequest : RoaAcsRequest<GetJobResponse>
    {
        public GetJobRequest()
            : base("foas", "2018-11-11", "GetJob", "foas", "openAPI")
        {
        ...
        public override GetJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
