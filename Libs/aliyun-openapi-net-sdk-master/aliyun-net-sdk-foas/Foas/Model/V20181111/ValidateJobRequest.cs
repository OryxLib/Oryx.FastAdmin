...
{
    public class ValidateJobRequest : RoaAcsRequest<ValidateJobResponse>
    {
        public ValidateJobRequest()
            : base("foas", "2018-11-11", "ValidateJob", "foas", "openAPI")
        {
			...
			UriPattern = "/api/v2/projects/[projectName]/jobs/[jobName]/validate";
