...
{
    public class GetFolderRequest : RoaAcsRequest<GetFolderResponse>
    {
        public GetFolderRequest()
            : base("foas", "2018-11-11", "GetFolder", "foas", "openAPI")
        {
        ...
        public override GetFolderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetFolderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
