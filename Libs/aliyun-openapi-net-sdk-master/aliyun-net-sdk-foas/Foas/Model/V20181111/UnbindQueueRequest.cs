...
{
    public class UnbindQueueRequest : RoaAcsRequest<UnbindQueueResponse>
    {
        public UnbindQueueRequest()
            : base("foas", "2018-11-11", "UnbindQueue", "foas", "openAPI")
        {
        ...
        public override UnbindQueueResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UnbindQueueResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
