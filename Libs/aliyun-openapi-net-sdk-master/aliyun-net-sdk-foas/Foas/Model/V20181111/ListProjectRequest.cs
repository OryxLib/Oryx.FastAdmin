...
{
    public class ListProjectRequest : RoaAcsRequest<ListProjectResponse>
    {
        public ListProjectRequest()
            : base("foas", "2018-11-11", "ListProject", "foas", "openAPI")
        {
        ...
        public override ListProjectResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListProjectResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
