...
{
    public class MoveResourceGroupRequest : RoaAcsRequest<MoveResourceGroupResponse>
    {
        public MoveResourceGroupRequest()
            : base("elasticsearch", "2017-06-13", "MoveResourceGroup", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/instances/[InstanceId]/resourcegroup";
