...
{
    public class AddConnectableClusterRequest : RoaAcsRequest<AddConnectableClusterResponse>
    {
        public AddConnectableClusterRequest()
            : base("elasticsearch", "2017-06-13", "AddConnectableCluster", "elasticsearch", "openAPI")
        {
        ...
        {
            return AddConnectableClusterResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
