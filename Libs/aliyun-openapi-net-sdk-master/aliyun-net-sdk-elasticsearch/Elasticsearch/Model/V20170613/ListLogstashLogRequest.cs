...
{
    public class ListLogstashLogRequest : RoaAcsRequest<ListLogstashLogResponse>
    {
        public ListLogstashLogRequest()
            : base("elasticsearch", "2017-06-13", "ListLogstashLog", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/logstashes/[InstanceId]/search-log";
        ...
        public override ListLogstashLogResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListLogstashLogResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
