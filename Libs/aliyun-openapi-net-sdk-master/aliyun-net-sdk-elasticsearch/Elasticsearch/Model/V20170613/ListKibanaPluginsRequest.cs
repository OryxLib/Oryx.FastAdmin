...
{
    public class ListKibanaPluginsRequest : RoaAcsRequest<ListKibanaPluginsResponse>
    {
        ...
        public override ListKibanaPluginsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListKibanaPluginsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
