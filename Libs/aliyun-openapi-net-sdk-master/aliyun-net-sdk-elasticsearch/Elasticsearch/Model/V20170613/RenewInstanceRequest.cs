...
{
    public class RenewInstanceRequest : RoaAcsRequest<RenewInstanceResponse>
    {
        public RenewInstanceRequest()
            : base("elasticsearch", "2017-06-13", "RenewInstance", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/instances/[InstanceId]/actions/renew";
