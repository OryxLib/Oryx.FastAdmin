...
{
    public class RestartLogstashRequest : RoaAcsRequest<RestartLogstashResponse>
    {
        public RestartLogstashRequest()
            : base("elasticsearch", "2017-06-13", "RestartLogstash", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/logstashes/[InstanceId]/actions/restart";
