...
{
    public class UpdatePublicNetworkRequest : RoaAcsRequest<UpdatePublicNetworkResponse>
    {
        ...
        public override UpdatePublicNetworkResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdatePublicNetworkResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
