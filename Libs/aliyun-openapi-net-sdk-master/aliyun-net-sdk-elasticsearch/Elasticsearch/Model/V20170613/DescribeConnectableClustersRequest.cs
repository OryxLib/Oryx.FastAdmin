...
{
    public class DescribeConnectableClustersRequest : RoaAcsRequest<DescribeConnectableClustersResponse>
    {
        public DescribeConnectableClustersRequest()
            : base("elasticsearch", "2017-06-13", "DescribeConnectableClusters", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/instances/[InstanceId]/connectable-clusters";
