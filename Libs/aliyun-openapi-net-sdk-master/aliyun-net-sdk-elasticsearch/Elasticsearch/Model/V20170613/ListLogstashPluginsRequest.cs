...
{
    public class ListLogstashPluginsRequest : RoaAcsRequest<ListLogstashPluginsResponse>
    {
        public ListLogstashPluginsRequest()
            : base("elasticsearch", "2017-06-13", "ListLogstashPlugins", "elasticsearch", "openAPI")
        {
        ...
        public override ListLogstashPluginsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListLogstashPluginsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
