...
namespace Aliyun.Acs.Market.Model.V20151101
{
    public class DescribeOrderRequest : RpcAcsRequest<DescribeOrderResponse>
    {
        ...
        public override DescribeOrderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeOrderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
