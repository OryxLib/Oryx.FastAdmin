...
{
    public class DescribeNetworkAnalyticsPacketLossRequest : RpcAcsRequest<DescribeNetworkAnalyticsPacketLossResponse>
    {
        public DescribeNetworkAnalyticsPacketLossRequest()
            : base("Netana", "2018-10-18", "DescribeNetworkAnalyticsPacketLoss", "Netana", "openAPI")
        {
        }
        ...
        public override DescribeNetworkAnalyticsPacketLossResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeNetworkAnalyticsPacketLossResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
