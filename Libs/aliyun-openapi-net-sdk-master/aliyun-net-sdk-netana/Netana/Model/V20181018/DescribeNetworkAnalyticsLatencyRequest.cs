...
{
    public class DescribeNetworkAnalyticsLatencyRequest : RpcAcsRequest<DescribeNetworkAnalyticsLatencyResponse>
    {
        public DescribeNetworkAnalyticsLatencyRequest()
            : base("Netana", "2018-10-18", "DescribeNetworkAnalyticsLatency", "Netana", "openAPI")
        {
        }
        ...
        public override DescribeNetworkAnalyticsLatencyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeNetworkAnalyticsLatencyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
