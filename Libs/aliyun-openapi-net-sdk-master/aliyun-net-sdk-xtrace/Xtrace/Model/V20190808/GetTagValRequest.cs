...
{
    public class GetTagValRequest : RpcAcsRequest<GetTagValResponse>
    {
        public GetTagValRequest()
            : base("xtrace", "2019-08-08", "GetTagVal", "xtrace", "openAPI")
        {
        ...
        public override GetTagValResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetTagValResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
