...
{
    public class UnmuteAudioRequest : RpcAcsRequest<UnmuteAudioResponse>
    {
        public UnmuteAudioRequest()
            : base("rtc", "2018-01-11", "UnmuteAudio", "rtc", "openAPI")
        {
        }
        ...
        public override UnmuteAudioResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UnmuteAudioResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
