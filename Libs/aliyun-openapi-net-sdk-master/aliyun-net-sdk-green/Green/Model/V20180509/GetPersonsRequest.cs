...
namespace Aliyun.Acs.Green.Model.V20180509
{
    public class GetPersonsRequest : RoaAcsRequest<GetPersonsResponse>
    {
        public GetPersonsRequest()
            : base("Green", "2018-05-09", "GetPersons")
        {
			...
			UriPattern = "/green/sface/group/persons";
        ...
        public override GetPersonsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
