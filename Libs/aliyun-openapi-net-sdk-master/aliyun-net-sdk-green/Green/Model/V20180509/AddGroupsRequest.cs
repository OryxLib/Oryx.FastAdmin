...
namespace Aliyun.Acs.Green.Model.V20180509
{
    public class AddGroupsRequest : RoaAcsRequest<AddGroupsResponse>
    {
        public AddGroupsRequest()
            : base("Green", "2018-05-09", "AddGroups")
        {
			...
			UriPattern = "/green/sface/person/groups/add";
        ...
        public override AddGroupsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
