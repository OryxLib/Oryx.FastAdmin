...
namespace Aliyun.Acs.Green.Model.V20180509
{
    public class GetAddVideoDnaResultsRequest : RoaAcsRequest<GetAddVideoDnaResultsResponse>
    {
            ...
            : base("Green", "2018-05-09", "GetAddVideoDnaResults")
        {
			...
			UriPattern = "/green/video/dna/add/results";
        ...
        public override GetAddVideoDnaResultsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAddVideoDnaResultsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
