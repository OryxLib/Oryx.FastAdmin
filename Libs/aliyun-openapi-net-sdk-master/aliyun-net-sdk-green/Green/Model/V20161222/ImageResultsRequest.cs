...
namespace Aliyun.Acs.Green.Model.V20161222
{
    public class ImageResultsRequest : RoaAcsRequest<ImageResultsResponse>
    {
            ...
            : base("Green", "2016-12-22", "ImageResults")
        {
			...
			UriPattern = "/image/results";
			Method = MethodType.POST;
        }

        public override ImageResultsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ImageResultsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
