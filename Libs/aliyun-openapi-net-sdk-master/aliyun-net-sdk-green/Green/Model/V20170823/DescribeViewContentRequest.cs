...
{
    public class DescribeViewContentRequest : RpcAcsRequest<DescribeViewContentResponse>
    {
        public DescribeViewContentRequest()
            : base("Green", "2017-08-23", "DescribeViewContent")
        {
        ...
        public override DescribeViewContentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeViewContentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
