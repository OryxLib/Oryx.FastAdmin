...
{
    public class MarkOssResultRequest : RpcAcsRequest<MarkOssResultResponse>
    {
        public MarkOssResultRequest()
            : base("Green", "2017-08-23", "MarkOssResult")
        {
        ...
        public override MarkOssResultResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return MarkOssResultResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
