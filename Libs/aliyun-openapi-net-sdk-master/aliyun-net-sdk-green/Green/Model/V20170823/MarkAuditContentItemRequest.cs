...
{
    public class MarkAuditContentItemRequest : RpcAcsRequest<MarkAuditContentItemResponse>
    {
        public MarkAuditContentItemRequest()
            : base("Green", "2017-08-23", "MarkAuditContentItem")
        {
        ...
        public override MarkAuditContentItemResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return MarkAuditContentItemResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
