...
{
    public class CreateImageLibRequest : RpcAcsRequest<CreateImageLibResponse>
    {
        public CreateImageLibRequest()
            : base("Green", "2017-08-23", "CreateImageLib")
        {
        ...
        public override CreateImageLibResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateImageLibResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
