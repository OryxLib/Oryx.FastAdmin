...
{
    public class CreateKeywordRequest : RpcAcsRequest<CreateKeywordResponse>
    {
        public CreateKeywordRequest()
            : base("Green", "2017-08-23", "CreateKeyword")
        {
        ...
        public override CreateKeywordResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateKeywordResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
