...
{
    public class RenewWebSiteInstanceRequest : RpcAcsRequest<RenewWebSiteInstanceResponse>
    {
        public RenewWebSiteInstanceRequest()
            : base("Green", "2017-08-23", "RenewWebSiteInstance")
        {
        ...
        public override RenewWebSiteInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RenewWebSiteInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
