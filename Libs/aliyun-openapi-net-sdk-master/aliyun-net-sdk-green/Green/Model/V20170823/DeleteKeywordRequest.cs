...
{
    public class DeleteKeywordRequest : RpcAcsRequest<DeleteKeywordResponse>
    {
        public DeleteKeywordRequest()
            : base("Green", "2017-08-23", "DeleteKeyword")
        {
        ...
        public override DeleteKeywordResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteKeywordResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
