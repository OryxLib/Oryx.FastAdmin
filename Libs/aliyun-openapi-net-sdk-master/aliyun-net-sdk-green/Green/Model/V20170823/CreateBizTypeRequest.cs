...
namespace Aliyun.Acs.Green.Model.V20170823
{
    public class CreateBizTypeRequest : RpcAcsRequest<CreateBizTypeResponse>
    {
		...
		public string IndustryInfo
		{
			...
			{
				industryInfo = value;
				DictionaryUtil.Add(QueryParameters, "IndustryInfo", value);
			}
		}
        ...
        public override CreateBizTypeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateBizTypeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
