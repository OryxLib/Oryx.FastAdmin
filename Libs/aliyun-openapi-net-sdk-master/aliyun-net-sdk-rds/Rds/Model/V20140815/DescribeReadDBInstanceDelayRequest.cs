...
namespace Aliyun.Acs.Rds.Model.V20140815
{
    public class DescribeReadDBInstanceDelayRequest : RpcAcsRequest<DescribeReadDBInstanceDelayResponse>
    {
		...
		public string ReadInstanceId
		{
			...
			set	
			{
				readInstanceId = value;
				DictionaryUtil.Add(QueryParameters, "ReadInstanceId", value);
			}
		}
        ...
        public override DescribeReadDBInstanceDelayResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeReadDBInstanceDelayResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
