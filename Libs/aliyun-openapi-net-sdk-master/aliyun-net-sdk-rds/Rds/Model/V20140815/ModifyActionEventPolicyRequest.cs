    ...
    public class ModifyActionEventPolicyRequest : RpcAcsRequest<ModifyActionEventPolicyResponse>
    {
		...
		public string EnableEventLog
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "EnableEventLog", value);
			}
		}

        public override ModifyActionEventPolicyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyActionEventPolicyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
