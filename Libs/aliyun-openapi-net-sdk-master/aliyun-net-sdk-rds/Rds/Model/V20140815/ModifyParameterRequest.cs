...
namespace Aliyun.Acs.Rds.Model.V20140815
{
    public class ModifyParameterRequest : RpcAcsRequest<ModifyParameterResponse>
    {
		...
		public bool? Forcerestart
		{
			...
			{
				forcerestart = value;
				DictionaryUtil.Add(QueryParameters, "Forcerestart", value.ToString());
			}
		}
        ...
        public override ModifyParameterResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyParameterResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
