    ...
    public class ModifyDTCSecurityIpHostsForSQLServerRequest : RpcAcsRequest<ModifyDTCSecurityIpHostsForSQLServerResponse>
    {
		...
		public string WhiteListGroupName
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "WhiteListGroupName", value);
			}
		}
		...
		public string SecurityIpHosts
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "SecurityIpHosts", value);
			}
		}
        ...
        public override ModifyDTCSecurityIpHostsForSQLServerResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDTCSecurityIpHostsForSQLServerResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
