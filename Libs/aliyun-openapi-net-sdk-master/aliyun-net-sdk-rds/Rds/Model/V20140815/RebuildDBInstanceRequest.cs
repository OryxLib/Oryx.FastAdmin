...
{
    public class RebuildDBInstanceRequest : RpcAcsRequest<RebuildDBInstanceResponse>
    {
        public RebuildDBInstanceRequest()
            : base("Rds", "2014-08-15", "RebuildDBInstance", "rds", "openAPI")
        {
