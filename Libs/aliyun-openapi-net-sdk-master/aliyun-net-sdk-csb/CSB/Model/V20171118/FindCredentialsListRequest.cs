...
namespace Aliyun.Acs.CSB.Model.V20171118
{
    public class FindCredentialsListRequest : RpcAcsRequest<FindCredentialsListResponse>
    {
        ...
        public override FindCredentialsListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return FindCredentialsListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
