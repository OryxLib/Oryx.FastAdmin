...
namespace Aliyun.Acs.CSB.Model.V20171118
{
    public class FindProjectsNameListRequest : RpcAcsRequest<FindProjectsNameListResponse>
    {
		...
		public string OperationFlag
		{
			...
			{
				operationFlag = value;
				DictionaryUtil.Add(QueryParameters, "OperationFlag", value);
			}
		}
        ...
        public override FindProjectsNameListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return FindProjectsNameListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
