...
namespace Aliyun.Acs.CSB.Model.V20171118
{
    public class UpdateProjectListStatusRequest : RpcAcsRequest<UpdateProjectListStatusResponse>
    {
        ...
        public override UpdateProjectListStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateProjectListStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
