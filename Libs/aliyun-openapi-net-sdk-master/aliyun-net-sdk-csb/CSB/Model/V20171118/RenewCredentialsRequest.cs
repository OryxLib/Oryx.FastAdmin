...
namespace Aliyun.Acs.CSB.Model.V20171118
{
    public class RenewCredentialsRequest : RpcAcsRequest<RenewCredentialsResponse>
    {
        ...
        public override RenewCredentialsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RenewCredentialsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
