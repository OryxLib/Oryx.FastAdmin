...
namespace Aliyun.Acs.CSB.Model.V20171118
{
    public class ReplaceCredentialRequest : RpcAcsRequest<ReplaceCredentialResponse>
    {
		...
		public long? CredentialId
		{
			...
			{
				credentialId = value;
				DictionaryUtil.Add(QueryParameters, "CredentialId", value.ToString());
			}
		}
        ...
        public override ReplaceCredentialResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReplaceCredentialResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
