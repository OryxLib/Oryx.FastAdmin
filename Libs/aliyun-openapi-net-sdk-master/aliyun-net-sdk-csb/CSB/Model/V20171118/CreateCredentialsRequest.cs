...
namespace Aliyun.Acs.CSB.Model.V20171118
{
    public class CreateCredentialsRequest : RpcAcsRequest<CreateCredentialsResponse>
    {
        ...
        public override CreateCredentialsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateCredentialsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
