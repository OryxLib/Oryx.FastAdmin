...
namespace Aliyun.Acs.CSB.Model.V20171118
{
    public class ApproveOrderListRequest : RpcAcsRequest<ApproveOrderListResponse>
    {
        ...
        public override ApproveOrderListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ApproveOrderListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
