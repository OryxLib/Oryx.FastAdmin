...
{
    public class FindInstanceListRequest : RpcAcsRequest<FindInstanceListResponse>
    {
        ...
        public override FindInstanceListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return FindInstanceListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
