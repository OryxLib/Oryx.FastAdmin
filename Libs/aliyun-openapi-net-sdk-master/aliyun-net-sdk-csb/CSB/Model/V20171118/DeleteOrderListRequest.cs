...
namespace Aliyun.Acs.CSB.Model.V20171118
{
    public class DeleteOrderListRequest : RpcAcsRequest<DeleteOrderListResponse>
    {
        ...
        public override DeleteOrderListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteOrderListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
