...
namespace Aliyun.Acs.CSB.Model.V20171118
{
    public class PublishCasServiceRequest : RpcAcsRequest<PublishCasServiceResponse>
    {
        ...
        public override PublishCasServiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PublishCasServiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
