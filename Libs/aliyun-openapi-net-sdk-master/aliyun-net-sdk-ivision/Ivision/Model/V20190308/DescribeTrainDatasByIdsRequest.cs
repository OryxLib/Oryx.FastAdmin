...
{
    public class DescribeTrainDatasByIdsRequest : RpcAcsRequest<DescribeTrainDatasByIdsResponse>
    {
        public DescribeTrainDatasByIdsRequest()
            : base("ivision", "2019-03-08", "DescribeTrainDatasByIds", "ivision", "openAPI")
        {
        }
        ...
        public override DescribeTrainDatasByIdsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeTrainDatasByIdsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
