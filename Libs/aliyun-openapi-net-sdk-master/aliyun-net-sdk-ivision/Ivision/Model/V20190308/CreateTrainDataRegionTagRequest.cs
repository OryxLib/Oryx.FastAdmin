...
{
    public class CreateTrainDataRegionTagRequest : RpcAcsRequest<CreateTrainDataRegionTagResponse>
    {
        public CreateTrainDataRegionTagRequest()
            : base("ivision", "2019-03-08", "CreateTrainDataRegionTag", "ivision", "openAPI")
        {
        }
        ...
        public override CreateTrainDataRegionTagResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateTrainDataRegionTagResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
