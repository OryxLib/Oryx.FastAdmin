...
{
    public class StartStreamPredictRequest : RpcAcsRequest<StartStreamPredictResponse>
    {
        ...
        public override StartStreamPredictResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StartStreamPredictResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
