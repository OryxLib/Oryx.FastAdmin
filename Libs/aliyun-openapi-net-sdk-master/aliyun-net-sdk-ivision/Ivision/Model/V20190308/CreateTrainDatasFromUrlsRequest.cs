...
{
    public class CreateTrainDatasFromUrlsRequest : RpcAcsRequest<CreateTrainDatasFromUrlsResponse>
    {
        public CreateTrainDatasFromUrlsRequest()
            : base("ivision", "2019-03-08", "CreateTrainDatasFromUrls", "ivision", "openAPI")
        {
        }
        ...
        public override CreateTrainDatasFromUrlsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateTrainDatasFromUrlsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
