...
{
    public class DescribeTrainDatasRequest : RpcAcsRequest<DescribeTrainDatasResponse>
    {
        public DescribeTrainDatasRequest()
            : base("ivision", "2019-03-08", "DescribeTrainDatas", "ivision", "openAPI")
        {
        }
		...
		public string TagStatus
		{
			...
			{
				tagStatus = value;
				DictionaryUtil.Add(QueryParameters, "TagStatus", value);
			}
		}
        ...
        public override DescribeTrainDatasResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeTrainDatasResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
