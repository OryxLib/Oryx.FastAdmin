...
{
    public class DeleteTrainDatasTagRequest : RpcAcsRequest<DeleteTrainDatasTagResponse>
    {
        public DeleteTrainDatasTagRequest()
            : base("ivision", "2019-03-08", "DeleteTrainDatasTag", "ivision", "openAPI")
        {
        }
        ...
        public override DeleteTrainDatasTagResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteTrainDatasTagResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
