...
{
    public class CreateTrainDataTagRequest : RpcAcsRequest<CreateTrainDataTagResponse>
    {
        public CreateTrainDataTagRequest()
            : base("ivision", "2019-03-08", "CreateTrainDataTag", "ivision", "openAPI")
        {
        }
        ...
        public override CreateTrainDataTagResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateTrainDataTagResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
