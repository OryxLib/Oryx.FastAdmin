...
{
    public class DeletePredictDatasRequest : RpcAcsRequest<DeletePredictDatasResponse>
    {
        public DeletePredictDatasRequest()
            : base("ivision", "2019-03-08", "DeletePredictDatas", "ivision", "openAPI")
        {
        }
        ...
        public override DeletePredictDatasResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeletePredictDatasResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
