...
{
    public class StartBaselineSecurityCheckRequest : RpcAcsRequest<StartBaselineSecurityCheckResponse>
    {
        ...
        public override StartBaselineSecurityCheckResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StartBaselineSecurityCheckResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
