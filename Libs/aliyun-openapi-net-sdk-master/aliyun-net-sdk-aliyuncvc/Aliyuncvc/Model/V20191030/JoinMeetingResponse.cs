...
{
	public class JoinMeetingResponse : AcsResponse
	{
		...
		private JoinMeeting_MeetingInfo meetingInfo;
		...
		public JoinMeeting_MeetingInfo MeetingInfo
		{
			get
			{
				return meetingInfo;
		...
		public class JoinMeeting_MeetingInfo
		{
			...
			private JoinMeeting_SlsInfo slsInfo;
			...
			public JoinMeeting_SlsInfo SlsInfo
			{
				get
				{
					return slsInfo;
			...
			public class JoinMeeting_SlsInfo
			{
