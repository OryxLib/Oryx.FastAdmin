...
{
	public class CheckMeetingCodeResponse : AcsResponse
	{
		...
		private CheckMeetingCode_MeetingInfo meetingInfo;
		...
		public CheckMeetingCode_MeetingInfo MeetingInfo
		{
			get
			{
				return meetingInfo;
		...
		public class CheckMeetingCode_MeetingInfo
		{
			...
			private CheckMeetingCode_SlsInfo slsInfo;
			...
			public CheckMeetingCode_SlsInfo SlsInfo
			{
				get
				{
					return slsInfo;
			...
			public class CheckMeetingCode_SlsInfo
			{
