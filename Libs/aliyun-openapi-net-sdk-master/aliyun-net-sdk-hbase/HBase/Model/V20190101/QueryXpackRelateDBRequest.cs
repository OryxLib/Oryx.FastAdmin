...
namespace Aliyun.Acs.HBase.Model.V20190101
{
    public class QueryXpackRelateDBRequest : RpcAcsRequest<QueryXpackRelateDBResponse>
    {
        ...
        public override QueryXpackRelateDBResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryXpackRelateDBResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
