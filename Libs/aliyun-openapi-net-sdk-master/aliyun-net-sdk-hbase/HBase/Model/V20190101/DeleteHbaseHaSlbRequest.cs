...
{
    public class DeleteHbaseHaSlbRequest : RpcAcsRequest<DeleteHbaseHaSlbResponse>
    {
        public DeleteHbaseHaSlbRequest()
            : base("HBase", "2019-01-01", "DeleteHbaseHaSlb", "hbase", "openAPI")
        {
        ...
        public override DeleteHbaseHaSlbResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteHbaseHaSlbResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
