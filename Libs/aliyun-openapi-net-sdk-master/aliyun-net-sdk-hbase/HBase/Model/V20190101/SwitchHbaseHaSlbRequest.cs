...
{
    public class SwitchHbaseHaSlbRequest : RpcAcsRequest<SwitchHbaseHaSlbResponse>
    {
        public SwitchHbaseHaSlbRequest()
            : base("HBase", "2019-01-01", "SwitchHbaseHaSlb", "hbase", "openAPI")
        {
        ...
        public override SwitchHbaseHaSlbResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SwitchHbaseHaSlbResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
