...
namespace Aliyun.Acs.HBase.Model.V20190101
{
    public class ResizeDiskSizeRequest : RpcAcsRequest<ResizeDiskSizeResponse>
    {
		...
		public int? NodeDiskSize
		{
			...
			{
				nodeDiskSize = value;
				DictionaryUtil.Add(QueryParameters, "NodeDiskSize", value.ToString());
			}
		}
        ...
        public override ResizeDiskSizeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ResizeDiskSizeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
