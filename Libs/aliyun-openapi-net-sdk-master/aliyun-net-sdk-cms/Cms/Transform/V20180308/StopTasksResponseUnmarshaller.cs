...
{
    public class StopTasksResponseUnmarshaller
    {
        public static StopTasksResponse Unmarshall(UnmarshallerContext context)
        {
			StopTasksResponse stopTasksResponse = new StopTasksResponse();

			stopTasksResponse.HttpResponse = context.HttpResponse;
			stopTasksResponse.Code = context.StringValue("StopTasks.Code");
