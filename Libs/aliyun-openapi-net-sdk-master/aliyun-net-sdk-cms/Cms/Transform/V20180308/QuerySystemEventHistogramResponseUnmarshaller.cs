...
namespace Aliyun.Acs.Cms.Transform.V20180308
{
    public class QuerySystemEventHistogramResponseUnmarshaller
    {
        public static QuerySystemEventHistogramResponse Unmarshall(UnmarshallerContext context)
        {
			...
			querySystemEventHistogramResponse.RequestId = context.StringValue("QuerySystemEventHistogram.RequestId");
			querySystemEventHistogramResponse.Success = context.StringValue("QuerySystemEventHistogram.Success");
