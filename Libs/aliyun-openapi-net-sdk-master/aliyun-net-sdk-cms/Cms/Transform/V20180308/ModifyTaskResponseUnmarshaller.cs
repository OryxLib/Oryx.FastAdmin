...
{
    public class ModifyTaskResponseUnmarshaller
    {
        public static ModifyTaskResponse Unmarshall(UnmarshallerContext context)
        {
			ModifyTaskResponse modifyTaskResponse = new ModifyTaskResponse();

			modifyTaskResponse.HttpResponse = context.HttpResponse;
			modifyTaskResponse.Code = context.StringValue("ModifyTask.Code");
