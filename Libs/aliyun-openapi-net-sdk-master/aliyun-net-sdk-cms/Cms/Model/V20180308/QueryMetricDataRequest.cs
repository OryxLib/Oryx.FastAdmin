...
{
    public class QueryMetricDataRequest : RpcAcsRequest<QueryMetricDataResponse>
    {
        public QueryMetricDataRequest()
            : base("Cms", "2018-03-08", "QueryMetricData", "cms", "openAPI")
        {
        }
        ...
        public override QueryMetricDataResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryMetricDataResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
