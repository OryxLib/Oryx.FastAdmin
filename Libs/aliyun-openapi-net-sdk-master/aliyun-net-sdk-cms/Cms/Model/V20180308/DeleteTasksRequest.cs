...
{
    public class DeleteTasksRequest : RpcAcsRequest<DeleteTasksResponse>
    {
        public DeleteTasksRequest()
            : base("Cms", "2018-03-08", "DeleteTasks", "cms", "openAPI")
        {
        }
        ...
        public override DeleteTasksResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteTasksResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
