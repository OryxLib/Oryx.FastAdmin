...
{
    public class CreateMonitoringTemplateRequest : RpcAcsRequest<CreateMonitoringTemplateResponse>
    {
        public CreateMonitoringTemplateRequest()
            : base("Cms", "2018-03-08", "CreateMonitoringTemplate", "cms", "openAPI")
        {
        }
        ...
        public override CreateMonitoringTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateMonitoringTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
