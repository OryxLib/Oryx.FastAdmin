...
{
    public class TaskConfigCreateRequest : RpcAcsRequest<TaskConfigCreateResponse>
    {
        public TaskConfigCreateRequest()
            : base("Cms", "2018-03-08", "TaskConfigCreate", "cms", "openAPI")
        {
        }
        ...
        public override TaskConfigCreateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return TaskConfigCreateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
