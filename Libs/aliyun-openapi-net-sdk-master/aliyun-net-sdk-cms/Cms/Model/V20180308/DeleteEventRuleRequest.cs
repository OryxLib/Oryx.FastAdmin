...
{
    public class DeleteEventRuleRequest : RpcAcsRequest<DeleteEventRuleResponse>
    {
        public DeleteEventRuleRequest()
            : base("Cms", "2018-03-08", "DeleteEventRule", "cms", "openAPI")
        {
        }
        ...
        public override DeleteEventRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteEventRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
