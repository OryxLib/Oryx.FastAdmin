...
namespace Aliyun.Acs.Cms.Model.V20180308
{
    public class ListProductOfActiveAlertRequest : RpcAcsRequest<ListProductOfActiveAlertResponse>
    {
        public ListProductOfActiveAlertRequest()
            : base("Cms", "2018-03-08", "ListProductOfActiveAlert", "cms", "openAPI")
        {
        }
        ...
        public override ListProductOfActiveAlertResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
