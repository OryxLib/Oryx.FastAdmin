...
namespace Aliyun.Acs.Cms.Model.V20180308
{
    public class EnableAlarmRequest : RpcAcsRequest<EnableAlarmResponse>
    {
        public EnableAlarmRequest()
            : base("Cms", "2018-03-08", "EnableAlarm", "cms", "openAPI")
        {
        }
        ...
        public override EnableAlarmResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnableAlarmResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
