...
namespace Aliyun.Acs.Cms.Model.V20180308
{
    public class UpdateMyGroupInstancesRequest : RpcAcsRequest<UpdateMyGroupInstancesResponse>
    {
        public UpdateMyGroupInstancesRequest()
            : base("Cms", "2018-03-08", "UpdateMyGroupInstances", "cms", "openAPI")
        {
        }
        ...
        public override UpdateMyGroupInstancesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
