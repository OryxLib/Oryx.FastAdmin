...
{
    public class CreateVServerGroupRequest : RpcAcsRequest<CreateVServerGroupResponse>
    {
        ...
        public override CreateVServerGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateVServerGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
