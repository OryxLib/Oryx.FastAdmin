...
{
    public class AddListenerWhiteListItemRequest : RpcAcsRequest<AddListenerWhiteListItemResponse>
    {
        ...
        public override AddListenerWhiteListItemResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddListenerWhiteListItemResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
