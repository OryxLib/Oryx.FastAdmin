...
{
    public class StopLoadBalancerListenerRequest : RpcAcsRequest<StopLoadBalancerListenerResponse>
    {
        ...
        public override StopLoadBalancerListenerResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopLoadBalancerListenerResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
