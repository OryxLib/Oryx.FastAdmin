...
{
    public class SetListenerAccessControlStatusRequest : RpcAcsRequest<SetListenerAccessControlStatusResponse>
    {
        ...
        public override SetListenerAccessControlStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SetListenerAccessControlStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
