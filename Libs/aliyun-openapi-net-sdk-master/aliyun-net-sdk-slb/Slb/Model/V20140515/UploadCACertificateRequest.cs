...
{
    public class UploadCACertificateRequest : RpcAcsRequest<UploadCACertificateResponse>
    {
        ...
        public override UploadCACertificateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UploadCACertificateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
