...
{
    public class CreateMasterSlaveServerGroupRequest : RpcAcsRequest<CreateMasterSlaveServerGroupResponse>
    {
		...
		public string MasterSlaveServerGroupName
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "MasterSlaveServerGroupName", value);
			}
		}
        ...
        public override CreateMasterSlaveServerGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateMasterSlaveServerGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
