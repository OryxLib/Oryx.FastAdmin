...
{
    public class SetVServerGroupAttributeRequest : RpcAcsRequest<SetVServerGroupAttributeResponse>
    {
        ...
        public override SetVServerGroupAttributeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SetVServerGroupAttributeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
