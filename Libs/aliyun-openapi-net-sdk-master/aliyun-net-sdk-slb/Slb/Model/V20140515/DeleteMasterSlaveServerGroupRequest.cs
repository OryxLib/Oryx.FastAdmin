...
{
    public class DeleteMasterSlaveServerGroupRequest : RpcAcsRequest<DeleteMasterSlaveServerGroupResponse>
    {
        ...
        public override DeleteMasterSlaveServerGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteMasterSlaveServerGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
