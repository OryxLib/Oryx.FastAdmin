...
namespace Aliyun.Acs.Slb.Model.V20140515
{
    public class DeleteVServerGroupRequest : RpcAcsRequest<DeleteVServerGroupResponse>
    {
        ...
        public override DeleteVServerGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteVServerGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
