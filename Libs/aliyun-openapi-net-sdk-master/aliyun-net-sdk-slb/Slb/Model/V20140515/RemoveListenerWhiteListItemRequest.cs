...
{
    public class RemoveListenerWhiteListItemRequest : RpcAcsRequest<RemoveListenerWhiteListItemResponse>
    {
        public RemoveListenerWhiteListItemRequest()
            : base("Slb", "2014-05-15", "RemoveListenerWhiteListItem", "slb", "openAPI")
        {
        ...
        public override RemoveListenerWhiteListItemResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveListenerWhiteListItemResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
