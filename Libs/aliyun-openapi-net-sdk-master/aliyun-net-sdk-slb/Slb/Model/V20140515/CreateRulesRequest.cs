...
{
    public class CreateRulesRequest : RpcAcsRequest<CreateRulesResponse>
    {
        ...
        public override CreateRulesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateRulesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
