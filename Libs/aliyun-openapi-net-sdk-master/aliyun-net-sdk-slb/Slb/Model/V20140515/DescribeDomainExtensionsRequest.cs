...
{
    public class DescribeDomainExtensionsRequest : RpcAcsRequest<DescribeDomainExtensionsResponse>
    {
        ...
        public override DescribeDomainExtensionsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDomainExtensionsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
