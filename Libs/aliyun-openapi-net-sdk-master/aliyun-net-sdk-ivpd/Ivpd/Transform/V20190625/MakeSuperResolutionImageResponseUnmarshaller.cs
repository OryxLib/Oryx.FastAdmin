...
namespace Aliyun.Acs.ivpd.Transform.V20190625
{
    public class MakeSuperResolutionImageResponseUnmarshaller
    {
        public static MakeSuperResolutionImageResponse Unmarshall(UnmarshallerContext context)
        {
			...
			makeSuperResolutionImageResponse.Code = context.StringValue("MakeSuperResolutionImage.Code");
			makeSuperResolutionImageResponse.Message = context.StringValue("MakeSuperResolutionImage.Message");
