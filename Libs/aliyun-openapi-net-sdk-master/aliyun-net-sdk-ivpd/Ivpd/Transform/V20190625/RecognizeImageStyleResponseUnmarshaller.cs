...
namespace Aliyun.Acs.ivpd.Transform.V20190625
{
    public class RecognizeImageStyleResponseUnmarshaller
    {
        public static RecognizeImageStyleResponse Unmarshall(UnmarshallerContext context)
        {
			...
			recognizeImageStyleResponse.Code = context.StringValue("RecognizeImageStyle.Code");
			recognizeImageStyleResponse.Message = context.StringValue("RecognizeImageStyle.Message");
