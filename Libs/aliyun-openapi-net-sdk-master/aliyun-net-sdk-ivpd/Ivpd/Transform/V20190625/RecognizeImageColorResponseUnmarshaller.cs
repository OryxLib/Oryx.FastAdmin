...
namespace Aliyun.Acs.ivpd.Transform.V20190625
{
    public class RecognizeImageColorResponseUnmarshaller
    {
        public static RecognizeImageColorResponse Unmarshall(UnmarshallerContext context)
        {
			...
			recognizeImageColorResponse.Code = context.StringValue("RecognizeImageColor.Code");
			recognizeImageColorResponse.Message = context.StringValue("RecognizeImageColor.Message");
