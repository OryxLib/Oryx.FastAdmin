...
namespace Aliyun.Acs.ivpd.Model.V20190625
{
    public class RecognizeImageColorRequest : RpcAcsRequest<RecognizeImageColorResponse>
    {
        public RecognizeImageColorRequest()
            : base("ivpd", "2019-06-25", "RecognizeImageColor", "ivpd", "openAPI")
        {
        ...
        public override RecognizeImageColorResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizeImageColorResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
