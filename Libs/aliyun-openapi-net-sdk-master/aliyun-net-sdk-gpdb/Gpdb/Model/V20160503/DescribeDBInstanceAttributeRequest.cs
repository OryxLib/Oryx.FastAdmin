...
namespace Aliyun.Acs.gpdb.Model.V20160503
{
    public class DescribeDBInstanceAttributeRequest : RpcAcsRequest<DescribeDBInstanceAttributeResponse>
    {
        public DescribeDBInstanceAttributeRequest()
            : base("gpdb", "2016-05-03", "DescribeDBInstanceAttribute", "gpdb", "openAPI")
        {
        }
        ...
        public override DescribeDBInstanceAttributeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDBInstanceAttributeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
