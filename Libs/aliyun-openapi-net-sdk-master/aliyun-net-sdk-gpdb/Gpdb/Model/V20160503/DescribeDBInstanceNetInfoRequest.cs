...
namespace Aliyun.Acs.gpdb.Model.V20160503
{
    public class DescribeDBInstanceNetInfoRequest : RpcAcsRequest<DescribeDBInstanceNetInfoResponse>
    {
        public DescribeDBInstanceNetInfoRequest()
            : base("gpdb", "2016-05-03", "DescribeDBInstanceNetInfo", "gpdb", "openAPI")
        {
        }
        ...
        public override DescribeDBInstanceNetInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDBInstanceNetInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
