...
namespace Aliyun.Acs.gpdb.Model.V20160503
{
    public class AddBuDBInstanceRelationRequest : RpcAcsRequest<AddBuDBInstanceRelationResponse>
    {
        ...
        public override AddBuDBInstanceRelationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddBuDBInstanceRelationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
