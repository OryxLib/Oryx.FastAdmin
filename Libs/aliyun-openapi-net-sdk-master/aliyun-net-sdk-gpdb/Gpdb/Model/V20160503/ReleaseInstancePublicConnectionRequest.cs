...
namespace Aliyun.Acs.gpdb.Model.V20160503
{
    public class ReleaseInstancePublicConnectionRequest : RpcAcsRequest<ReleaseInstancePublicConnectionResponse>
    {
        public ReleaseInstancePublicConnectionRequest()
            : base("gpdb", "2016-05-03", "ReleaseInstancePublicConnection", "gpdb", "openAPI")
        {
        }
        ...
        public override ReleaseInstancePublicConnectionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReleaseInstancePublicConnectionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
