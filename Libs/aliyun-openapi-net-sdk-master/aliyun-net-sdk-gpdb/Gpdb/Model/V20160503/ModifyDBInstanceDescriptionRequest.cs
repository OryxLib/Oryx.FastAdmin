...
namespace Aliyun.Acs.gpdb.Model.V20160503
{
    public class ModifyDBInstanceDescriptionRequest : RpcAcsRequest<ModifyDBInstanceDescriptionResponse>
    {
        public ModifyDBInstanceDescriptionRequest()
            : base("gpdb", "2016-05-03", "ModifyDBInstanceDescription", "gpdb", "openAPI")
        {
        }
        ...
        public override ModifyDBInstanceDescriptionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDBInstanceDescriptionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
