...
{
    public class MoveAlbumPhotosRequest : RpcAcsRequest<MoveAlbumPhotosResponse>
    {
        public MoveAlbumPhotosRequest()
            : base("CloudPhoto", "2017-07-11", "MoveAlbumPhotos", "cloudphoto", "openAPI")
        {
		...
		public long? SourceAlbumId
		{
			...
			{
				sourceAlbumId = value;
				DictionaryUtil.Add(QueryParameters, "SourceAlbumId", value.ToString());
			}
		}
		...
		public long? TargetAlbumId
		{
			...
			{
				targetAlbumId = value;
				DictionaryUtil.Add(QueryParameters, "TargetAlbumId", value.ToString());
			}
		}
        ...
        public override MoveAlbumPhotosResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return MoveAlbumPhotosResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
