...
{
    public class RenameAlbumRequest : RpcAcsRequest<RenameAlbumResponse>
    {
        public RenameAlbumRequest()
            : base("CloudPhoto", "2017-07-11", "RenameAlbum", "cloudphoto", "openAPI")
        {
        ...
        public override RenameAlbumResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RenameAlbumResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
