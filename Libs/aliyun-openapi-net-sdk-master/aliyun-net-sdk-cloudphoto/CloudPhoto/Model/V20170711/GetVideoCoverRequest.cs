...
{
    public class GetVideoCoverRequest : RpcAcsRequest<GetVideoCoverResponse>
    {
        public GetVideoCoverRequest()
            : base("CloudPhoto", "2017-07-11", "GetVideoCover", "cloudphoto", "openAPI")
        {
        ...
        public override GetVideoCoverResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetVideoCoverResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
