...
{
    public class ListPhotosRequest : RpcAcsRequest<ListPhotosResponse>
    {
        public ListPhotosRequest()
            : base("CloudPhoto", "2017-07-11", "ListPhotos", "cloudphoto", "openAPI")
        {
        ...
        public override ListPhotosResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListPhotosResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
