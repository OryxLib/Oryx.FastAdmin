...
{
    public class InactivatePhotosRequest : RpcAcsRequest<InactivatePhotosResponse>
    {
        public InactivatePhotosRequest()
            : base("CloudPhoto", "2017-07-11", "InactivatePhotos", "cloudphoto", "openAPI")
        {
        ...
        public override InactivatePhotosResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InactivatePhotosResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
