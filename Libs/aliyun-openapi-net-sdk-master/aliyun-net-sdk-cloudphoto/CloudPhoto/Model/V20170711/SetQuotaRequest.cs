...
{
    public class SetQuotaRequest : RpcAcsRequest<SetQuotaResponse>
    {
        public SetQuotaRequest()
            : base("CloudPhoto", "2017-07-11", "SetQuota", "cloudphoto", "openAPI")
        {
        ...
        public override SetQuotaResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SetQuotaResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
