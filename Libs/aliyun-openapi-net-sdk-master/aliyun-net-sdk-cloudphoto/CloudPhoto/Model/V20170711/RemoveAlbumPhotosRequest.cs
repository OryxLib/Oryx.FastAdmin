...
{
    public class RemoveAlbumPhotosRequest : RpcAcsRequest<RemoveAlbumPhotosResponse>
    {
        public RemoveAlbumPhotosRequest()
            : base("CloudPhoto", "2017-07-11", "RemoveAlbumPhotos", "cloudphoto", "openAPI")
        {
        ...
        public override RemoveAlbumPhotosResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveAlbumPhotosResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
