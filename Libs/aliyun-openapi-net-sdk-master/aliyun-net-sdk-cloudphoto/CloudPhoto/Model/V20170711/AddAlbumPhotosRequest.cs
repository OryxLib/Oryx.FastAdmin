...
{
    public class AddAlbumPhotosRequest : RpcAcsRequest<AddAlbumPhotosResponse>
    {
        public AddAlbumPhotosRequest()
            : base("CloudPhoto", "2017-07-11", "AddAlbumPhotos", "cloudphoto", "openAPI")
        {
        ...
        public override AddAlbumPhotosResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddAlbumPhotosResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
