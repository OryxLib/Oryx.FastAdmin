...
{
    public class GetThumbnailsRequest : RpcAcsRequest<GetThumbnailsResponse>
    {
        public GetThumbnailsRequest()
            : base("CloudPhoto", "2017-07-11", "GetThumbnails", "cloudphoto", "openAPI")
        {
        ...
        public override GetThumbnailsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetThumbnailsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
