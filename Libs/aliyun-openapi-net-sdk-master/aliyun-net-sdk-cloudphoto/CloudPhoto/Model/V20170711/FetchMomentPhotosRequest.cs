...
{
    public class FetchMomentPhotosRequest : RpcAcsRequest<FetchMomentPhotosResponse>
    {
        public FetchMomentPhotosRequest()
            : base("CloudPhoto", "2017-07-11", "FetchMomentPhotos", "cloudphoto", "openAPI")
        {
        ...
        public override FetchMomentPhotosResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return FetchMomentPhotosResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
