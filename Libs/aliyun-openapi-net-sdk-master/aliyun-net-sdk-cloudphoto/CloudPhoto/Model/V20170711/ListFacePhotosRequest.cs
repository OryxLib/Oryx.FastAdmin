...
{
    public class ListFacePhotosRequest : RpcAcsRequest<ListFacePhotosResponse>
    {
        public ListFacePhotosRequest()
            : base("CloudPhoto", "2017-07-11", "ListFacePhotos", "cloudphoto", "openAPI")
        {
        ...
        public override ListFacePhotosResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListFacePhotosResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
