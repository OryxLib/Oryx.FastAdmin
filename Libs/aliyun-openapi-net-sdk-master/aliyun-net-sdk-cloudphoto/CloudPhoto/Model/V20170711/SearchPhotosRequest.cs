...
{
    public class SearchPhotosRequest : RpcAcsRequest<SearchPhotosResponse>
    {
        public SearchPhotosRequest()
            : base("CloudPhoto", "2017-07-11", "SearchPhotos", "cloudphoto", "openAPI")
        {
        ...
        public override SearchPhotosResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SearchPhotosResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
