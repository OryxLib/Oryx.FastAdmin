...
{
    public class ListAlbumsRequest : RpcAcsRequest<ListAlbumsResponse>
    {
        public ListAlbumsRequest()
            : base("CloudPhoto", "2017-07-11", "ListAlbums", "cloudphoto", "openAPI")
        {
        ...
        public override ListAlbumsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListAlbumsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
