...
{
    public class GetThumbnailRequest : RpcAcsRequest<GetThumbnailResponse>
    {
        public GetThumbnailRequest()
            : base("CloudPhoto", "2017-07-11", "GetThumbnail", "cloudphoto", "openAPI")
        {
        ...
        public override GetThumbnailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetThumbnailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
