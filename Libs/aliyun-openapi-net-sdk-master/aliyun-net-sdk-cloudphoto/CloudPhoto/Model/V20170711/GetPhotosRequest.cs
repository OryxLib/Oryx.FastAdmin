...
{
    public class GetPhotosRequest : RpcAcsRequest<GetPhotosResponse>
    {
        public GetPhotosRequest()
            : base("CloudPhoto", "2017-07-11", "GetPhotos", "cloudphoto", "openAPI")
        {
        ...
        public override GetPhotosResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPhotosResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
