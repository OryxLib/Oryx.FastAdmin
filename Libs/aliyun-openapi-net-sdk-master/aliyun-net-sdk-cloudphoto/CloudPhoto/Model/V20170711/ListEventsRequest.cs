...
{
    public class ListEventsRequest : RpcAcsRequest<ListEventsResponse>
    {
        public ListEventsRequest()
            : base("CloudPhoto", "2017-07-11", "ListEvents", "cloudphoto", "openAPI")
        {
        ...
        public override ListEventsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListEventsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
