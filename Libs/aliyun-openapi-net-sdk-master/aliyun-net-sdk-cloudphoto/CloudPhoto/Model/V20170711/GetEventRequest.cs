...
{
    public class GetEventRequest : RpcAcsRequest<GetEventResponse>
    {
        public GetEventRequest()
            : base("CloudPhoto", "2017-07-11", "GetEvent", "cloudphoto", "openAPI")
        {
        ...
        public override GetEventResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetEventResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
