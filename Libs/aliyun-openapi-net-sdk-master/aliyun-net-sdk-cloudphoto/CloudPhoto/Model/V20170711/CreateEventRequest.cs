...
{
    public class CreateEventRequest : RpcAcsRequest<CreateEventResponse>
    {
        public CreateEventRequest()
            : base("CloudPhoto", "2017-07-11", "CreateEvent", "cloudphoto", "openAPI")
        {
        ...
        public override CreateEventResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateEventResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
