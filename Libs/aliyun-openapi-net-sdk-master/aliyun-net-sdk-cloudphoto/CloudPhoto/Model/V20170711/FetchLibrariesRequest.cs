...
{
    public class FetchLibrariesRequest : RpcAcsRequest<FetchLibrariesResponse>
    {
        public FetchLibrariesRequest()
            : base("CloudPhoto", "2017-07-11", "FetchLibraries", "cloudphoto", "openAPI")
        {
        ...
        public override FetchLibrariesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
