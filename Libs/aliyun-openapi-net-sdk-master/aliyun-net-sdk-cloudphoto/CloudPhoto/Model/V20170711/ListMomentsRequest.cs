...
{
    public class ListMomentsRequest : RpcAcsRequest<ListMomentsResponse>
    {
        public ListMomentsRequest()
            : base("CloudPhoto", "2017-07-11", "ListMoments", "cloudphoto", "openAPI")
        {
        ...
        public override ListMomentsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListMomentsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
