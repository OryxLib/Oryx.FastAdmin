...
{
    public class DeletePhotosRequest : RpcAcsRequest<DeletePhotosResponse>
    {
        ...
        public override DeletePhotosResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeletePhotosResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
