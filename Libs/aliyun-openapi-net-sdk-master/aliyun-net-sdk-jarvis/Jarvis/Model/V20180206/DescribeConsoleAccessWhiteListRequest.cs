...
{
    public class DescribeConsoleAccessWhiteListRequest : RpcAcsRequest<DescribeConsoleAccessWhiteListResponse>
    {
        public DescribeConsoleAccessWhiteListRequest()
            : base("jarvis", "2018-02-06", "DescribeConsoleAccessWhiteList", "jarvis", "openAPI")
        {
        }
        ...
        public override DescribeConsoleAccessWhiteListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeConsoleAccessWhiteListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
