...
{
    public class ModifyUidWhiteListAutoShareRequest : RpcAcsRequest<ModifyUidWhiteListAutoShareResponse>
    {
        public ModifyUidWhiteListAutoShareRequest()
            : base("jarvis", "2018-02-06", "ModifyUidWhiteListAutoShare", "jarvis", "openAPI")
        {
        }
        ...
        public override ModifyUidWhiteListAutoShareResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyUidWhiteListAutoShareResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
