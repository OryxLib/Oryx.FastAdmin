...
{
    public class DescribeCpmcPunishListRequest : RpcAcsRequest<DescribeCpmcPunishListResponse>
    {
        public DescribeCpmcPunishListRequest()
            : base("jarvis", "2018-02-06", "DescribeCpmcPunishList", "jarvis", "openAPI")
        {
        }
        ...
        public override DescribeCpmcPunishListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeCpmcPunishListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
