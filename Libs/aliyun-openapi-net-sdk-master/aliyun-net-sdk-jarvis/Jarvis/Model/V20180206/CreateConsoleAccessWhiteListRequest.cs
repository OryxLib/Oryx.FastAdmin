...
{
    public class CreateConsoleAccessWhiteListRequest : RpcAcsRequest<CreateConsoleAccessWhiteListResponse>
    {
        public CreateConsoleAccessWhiteListRequest()
            : base("jarvis", "2018-02-06", "CreateConsoleAccessWhiteList", "jarvis", "openAPI")
        {
        }
        ...
        public override CreateConsoleAccessWhiteListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateConsoleAccessWhiteListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
