...
namespace Aliyun.Acs.cloudesl.Model.V20190801
{
    public class UnassignUserRequest : RpcAcsRequest<UnassignUserResponse>
    {
        public UnassignUserRequest()
            : base("cloudesl", "2019-08-01", "UnassignUser", "cloudesl", "openAPI")
        {
        ...
        public override UnassignUserResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UnassignUserResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
