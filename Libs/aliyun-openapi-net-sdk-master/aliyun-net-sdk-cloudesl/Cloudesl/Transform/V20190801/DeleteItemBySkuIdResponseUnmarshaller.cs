...
namespace Aliyun.Acs.cloudesl.Transform.V20190801
{
    public class DeleteItemBySkuIdResponseUnmarshaller
    {
        public static DeleteItemBySkuIdResponse Unmarshall(UnmarshallerContext context)
        {
			...
			deleteItemBySkuIdResponse.ErrorMessage = context.StringValue("DeleteItemBySkuId.ErrorMessage");
			...
			deleteItemBySkuIdResponse.DynamicCode = context.StringValue("DeleteItemBySkuId.DynamicCode");
			deleteItemBySkuIdResponse.Code = context.StringValue("DeleteItemBySkuId.Code");
			deleteItemBySkuIdResponse.DynamicMessage = context.StringValue("DeleteItemBySkuId.DynamicMessage");
