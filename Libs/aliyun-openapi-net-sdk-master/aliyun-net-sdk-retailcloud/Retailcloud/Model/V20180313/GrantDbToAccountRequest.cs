...
namespace Aliyun.Acs.retailcloud.Model.V20180313
{
    public class GrantDbToAccountRequest : RpcAcsRequest<GrantDbToAccountResponse>
    {
        ...
        public override GrantDbToAccountResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GrantDbToAccountResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
