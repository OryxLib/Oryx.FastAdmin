...
{
    public class GetLocationsRequest : RpcAcsRequest<GetLocationsResponse>
    {
        public GetLocationsRequest()
            : base("cusanalytic_sc_online", "2019-05-24", "GetLocations")
        {
        ...
        public override GetLocationsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetLocationsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
