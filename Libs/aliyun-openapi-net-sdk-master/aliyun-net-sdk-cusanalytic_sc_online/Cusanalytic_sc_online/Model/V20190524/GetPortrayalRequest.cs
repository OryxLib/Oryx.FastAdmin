...
{
    public class GetPortrayalRequest : RpcAcsRequest<GetPortrayalResponse>
    {
        public GetPortrayalRequest()
            : base("cusanalytic_sc_online", "2019-05-24", "GetPortrayal")
        {
        ...
        public override GetPortrayalResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPortrayalResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
