...
{
    public class GetEMapRequest : RpcAcsRequest<GetEMapResponse>
    {
        public GetEMapRequest()
            : base("cusanalytic_sc_online", "2019-05-24", "GetEMap")
        {
        ...
        public override GetEMapResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetEMapResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
