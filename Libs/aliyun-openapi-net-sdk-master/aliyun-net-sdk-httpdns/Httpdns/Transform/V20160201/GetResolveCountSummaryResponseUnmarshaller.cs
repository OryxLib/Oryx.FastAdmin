...
namespace Aliyun.Acs.Httpdns.Transform.V20160201
{
    ...
    {
        public static GetResolveCountSummaryResponse Unmarshall(UnmarshallerContext context)
        {
			GetResolveCountSummaryResponse getResolveCountSummaryResponse = new GetResolveCountSummaryResponse();

			getResolveCountSummaryResponse.HttpResponse = context.HttpResponse;
			getResolveCountSummaryResponse.RequestId = context.StringValue("GetResolveCountSummary.RequestId");
