...
namespace Aliyun.Acs.Httpdns.Model.V20160201
{
    public class ListDomainsRequest : RpcAcsRequest<ListDomainsResponse>
    {
        ...
        public override ListDomainsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDomainsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
