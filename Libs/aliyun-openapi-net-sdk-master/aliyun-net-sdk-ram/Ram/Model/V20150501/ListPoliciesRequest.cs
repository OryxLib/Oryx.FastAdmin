...
{
    public class ListPoliciesRequest : RpcAcsRequest<ListPoliciesResponse>
    {
        public ListPoliciesRequest()
            : base("Ram", "2015-05-01", "ListPolicies")
        {
        ...
        {
            return ListPoliciesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
