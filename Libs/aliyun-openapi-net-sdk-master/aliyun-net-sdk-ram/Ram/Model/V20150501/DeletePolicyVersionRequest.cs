...
{
    public class DeletePolicyVersionRequest : RpcAcsRequest<DeletePolicyVersionResponse>
    {
        public DeletePolicyVersionRequest()
            : base("Ram", "2015-05-01", "DeletePolicyVersion")
        {
        ...
        {
            return DeletePolicyVersionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
