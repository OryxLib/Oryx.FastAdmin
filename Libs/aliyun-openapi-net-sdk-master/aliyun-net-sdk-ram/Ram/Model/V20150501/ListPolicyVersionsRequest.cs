...
{
    public class ListPolicyVersionsRequest : RpcAcsRequest<ListPolicyVersionsResponse>
    {
        public ListPolicyVersionsRequest()
            : base("Ram", "2015-05-01", "ListPolicyVersions")
        {
        ...
        {
            return ListPolicyVersionsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
