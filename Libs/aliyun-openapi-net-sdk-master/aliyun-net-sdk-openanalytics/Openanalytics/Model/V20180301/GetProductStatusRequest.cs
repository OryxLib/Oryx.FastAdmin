...
{
    public class GetProductStatusRequest : RpcAcsRequest<GetProductStatusResponse>
    {
        public GetProductStatusRequest()
            : base("openanalytics", "2018-03-01", "GetProductStatus", "openanalytics", "openAPI")
        {
        }
        ...
        public override GetProductStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetProductStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
