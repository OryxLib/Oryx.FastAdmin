...
{
    public class CloseProductAccountRequest : RpcAcsRequest<CloseProductAccountResponse>
    {
        public CloseProductAccountRequest()
            : base("openanalytics", "2018-03-01", "CloseProductAccount", "openanalytics", "openAPI")
        {
        }
        ...
        public override CloseProductAccountResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CloseProductAccountResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
