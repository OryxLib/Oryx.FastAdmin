...
namespace Aliyun.Acs.Dypnsapi.Model.V20170525
{
    public class DescribeVerifySchemeRequest : RpcAcsRequest<DescribeVerifySchemeResponse>
    {
        ...
        public override DescribeVerifySchemeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeVerifySchemeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
