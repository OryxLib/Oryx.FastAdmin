...
namespace Aliyun.Acs.Dypnsapi.Model.V20170525
{
    public class DeleteVerifySchemeRequest : RpcAcsRequest<DeleteVerifySchemeResponse>
    {
        ...
        public override DeleteVerifySchemeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteVerifySchemeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
