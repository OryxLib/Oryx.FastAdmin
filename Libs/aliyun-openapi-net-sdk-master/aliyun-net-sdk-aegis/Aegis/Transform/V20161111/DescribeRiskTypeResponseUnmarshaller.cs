...
namespace Aliyun.Acs.aegis.Transform.V20161111
{
    ...
    {
        public static DescribeRiskTypeResponse Unmarshall(UnmarshallerContext context)
        {
			DescribeRiskTypeResponse describeRiskTypeResponse = new DescribeRiskTypeResponse();

			describeRiskTypeResponse.HttpResponse = context.HttpResponse;
			describeRiskTypeResponse.RequestId = context.StringValue("DescribeRiskType.RequestId");
			describeRiskTypeResponse.Count = context.IntegerValue("DescribeRiskType.Count");
			...
			for (int i = 0; i < context.Length("DescribeRiskType.RiskTypes.Length"); i++) {
				DescribeRiskTypeResponse.DescribeRiskType_RiskType riskType = new DescribeRiskTypeResponse.DescribeRiskType_RiskType();
				riskType.TypeName = context.StringValue("DescribeRiskType.RiskTypes["+ i +"].TypeName");
				riskType.Alias = context.StringValue("DescribeRiskType.RiskTypes["+ i +"].Alias");
				riskType.WarnCount = context.StringValue("DescribeRiskType.RiskTypes["+ i +"].WarnCount");
				...
				for (int j = 0; j < context.Length("DescribeRiskType.RiskTypes["+ i +"].SubTypes.Length"); j++) {
					...
					subType.WarnCount = context.StringValue("DescribeRiskType.RiskTypes["+ i +"].SubTypes["+ j +"].WarnCount");
					subType.TypeName = context.StringValue("DescribeRiskType.RiskTypes["+ i +"].SubTypes["+ j +"].TypeName");
					subType.Alias = context.StringValue("DescribeRiskType.RiskTypes["+ i +"].SubTypes["+ j +"].Alias");
