...
{
    public class DescribeWebLockEventsRequest : RpcAcsRequest<DescribeWebLockEventsResponse>
    {
        public DescribeWebLockEventsRequest()
            : base("aegis", "2016-11-11", "DescribeWebLockEvents", "vipaegis", "openAPI")
        {
        }
        ...
        public override DescribeWebLockEventsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeWebLockEventsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
