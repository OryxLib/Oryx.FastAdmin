...
{
    public class DescribeTraceInfoDetailRequest : RpcAcsRequest<DescribeTraceInfoDetailResponse>
    {
        public DescribeTraceInfoDetailRequest()
            : base("aegis", "2016-11-11", "DescribeTraceInfoDetail", "vipaegis", "openAPI")
        {
        }
