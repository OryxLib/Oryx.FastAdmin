...
{
    public class ModifyWebLockCreateConfigRequest : RpcAcsRequest<ModifyWebLockCreateConfigResponse>
    {
        public ModifyWebLockCreateConfigRequest()
            : base("aegis", "2016-11-11", "ModifyWebLockCreateConfig", "vipaegis", "openAPI")
        {
        }
        ...
        public override ModifyWebLockCreateConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyWebLockCreateConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
