...
{
    public class DescribeScreenAlarmEventListRequest : RpcAcsRequest<DescribeScreenAlarmEventListResponse>
    {
        public DescribeScreenAlarmEventListRequest()
            : base("aegis", "2016-11-11", "DescribeScreenAlarmEventList", "vipaegis", "openAPI")
        {
        }
		...
		public string AlarmEventName
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "AlarmEventName", value);
			}
		}
        ...
        public override DescribeScreenAlarmEventListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeScreenAlarmEventListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
