...
namespace Aliyun.Acs.aegis.Model.V20161111
{
    public class DeleteRuleRequest : RpcAcsRequest<DeleteRuleResponse>
    {
        public DeleteRuleRequest()
            : base("aegis", "2016-11-11", "DeleteRule", "vipaegis", "openAPI")
        {
        }
        ...
        public override DeleteRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
