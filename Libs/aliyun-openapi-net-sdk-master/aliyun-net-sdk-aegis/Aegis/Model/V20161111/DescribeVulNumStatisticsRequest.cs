...
{
    public class DescribeVulNumStatisticsRequest : RpcAcsRequest<DescribeVulNumStatisticsResponse>
    {
        public DescribeVulNumStatisticsRequest()
            : base("aegis", "2016-11-11", "DescribeVulNumStatistics", "vipaegis", "openAPI")
        {
        }
        ...
        public override DescribeVulNumStatisticsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeVulNumStatisticsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
