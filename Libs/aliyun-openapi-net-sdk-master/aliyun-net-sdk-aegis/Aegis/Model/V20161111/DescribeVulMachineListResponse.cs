...
{
	public class DescribeVulMachineListResponse : AcsResponse
	{
		...
		private List<DescribeVulMachineList_MachineStatistic> machineStatistics;
		...
		public List<DescribeVulMachineList_MachineStatistic> MachineStatistics
		{
			get
			{
			...
			set	
			{
				machineStatistics = value;
			}
		}

		public class DescribeVulMachineList_MachineStatistic
		{
