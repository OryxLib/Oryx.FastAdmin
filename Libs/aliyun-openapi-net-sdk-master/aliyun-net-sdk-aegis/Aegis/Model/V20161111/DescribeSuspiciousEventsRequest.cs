...
{
    public class DescribeSuspiciousEventsRequest : RpcAcsRequest<DescribeSuspiciousEventsResponse>
    {
        public DescribeSuspiciousEventsRequest()
            : base("aegis", "2016-11-11", "DescribeSuspiciousEvents", "vipaegis", "openAPI")
        {
        }
