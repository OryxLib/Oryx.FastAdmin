...
{
    public class DescribesummaryRequest : RpcAcsRequest<DescribesummaryResponse>
    {
        public DescribesummaryRequest()
            : base("aegis", "2016-11-11", "Describesummary", "vipaegis", "openAPI")
        {
        }
        ...
        public override DescribesummaryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribesummaryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
