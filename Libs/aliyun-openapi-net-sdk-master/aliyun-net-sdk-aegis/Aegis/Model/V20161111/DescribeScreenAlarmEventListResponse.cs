...
{
	public class DescribeScreenAlarmEventListResponse : AcsResponse
	{

		private string requestId;

		private List<DescribeScreenAlarmEventList_SuspEventsItem> suspEvents;

		private DescribeScreenAlarmEventList_PageInfo pageInfo;
		...
		public List<DescribeScreenAlarmEventList_SuspEventsItem> SuspEvents
		{
			get
			{
				return suspEvents;
		...
		public DescribeScreenAlarmEventList_PageInfo PageInfo
		{
			get
			{
				return pageInfo;
		...
		public class DescribeScreenAlarmEventList_SuspEventsItem
		{
		...
		public class DescribeScreenAlarmEventList_PageInfo
		{
