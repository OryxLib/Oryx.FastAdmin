...
namespace Aliyun.Acs.aegis.Model.V20161111
{
    public class DescribeAlarmEventListRequest : RpcAcsRequest<DescribeAlarmEventListResponse>
    {
        public DescribeAlarmEventListRequest()
            : base("aegis", "2016-11-11", "DescribeAlarmEventList", "vipaegis", "openAPI")
        {
        }
        ...
        public override DescribeAlarmEventListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAlarmEventListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
