...
namespace Aliyun.Acs.aegis.Model.V20161111
{
    public class DescribeSuspEventDetailRequest : RpcAcsRequest<DescribeSuspEventDetailResponse>
    {
        public DescribeSuspEventDetailRequest()
            : base("aegis", "2016-11-11", "DescribeSuspEventDetail", "vipaegis", "openAPI")
        {
        }
        ...
        public override DescribeSuspEventDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSuspEventDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
