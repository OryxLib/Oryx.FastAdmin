...
{
    public class CreateTagJobRequest : RpcAcsRequest<CreateTagJobResponse>
    {
        public CreateTagJobRequest()
            : base("imm", "2017-09-06", "CreateTagJob", "imm", "openAPI")
        {
        }
        ...
        public override CreateTagJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateTagJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
