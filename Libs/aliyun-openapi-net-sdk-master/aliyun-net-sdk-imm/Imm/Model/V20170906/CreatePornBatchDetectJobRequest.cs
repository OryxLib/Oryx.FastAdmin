...
{
    public class CreatePornBatchDetectJobRequest : RpcAcsRequest<CreatePornBatchDetectJobResponse>
    {
        public CreatePornBatchDetectJobRequest()
            : base("imm", "2017-09-06", "CreatePornBatchDetectJob", "imm", "openAPI")
        {
        }
        ...
        public override CreatePornBatchDetectJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreatePornBatchDetectJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
