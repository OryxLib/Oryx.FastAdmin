...
namespace Aliyun.Acs.imm.Model.V20170906
{
    public class CreateStreamAnalyseTaskRequest : RpcAcsRequest<CreateStreamAnalyseTaskResponse>
    {
		...
		public string StreamUri
		{
			...
			{
				streamUri = value;
				DictionaryUtil.Add(QueryParameters, "StreamUri", value);
			}
		}
        ...
        public override CreateStreamAnalyseTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateStreamAnalyseTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
