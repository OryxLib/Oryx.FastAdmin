...
{
    public class CreateDocIndexTaskRequest : RpcAcsRequest<CreateDocIndexTaskResponse>
    {
        public CreateDocIndexTaskRequest()
            : base("imm", "2017-09-06", "CreateDocIndexTask", "imm", "openAPI")
        {
        }
        ...
        public override CreateDocIndexTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateDocIndexTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
