...
namespace Aliyun.Acs.scdn.Model.V20171115
{
	public class DescribeScdnDomainTopUrlVisitResponse : AcsResponse
	{
		...
		private List<DescribeScdnDomainTopUrlVisit_UrlList> url200List;

		private List<DescribeScdnDomainTopUrlVisit_UrlList> url300List;
		...
		public List<DescribeScdnDomainTopUrlVisit_UrlList> AllUrlList
		{
			get
			{
				return allUrlList;
		...
		public List<DescribeScdnDomainTopUrlVisit_UrlList> Url200List
		{
			get
			{
				return url200List;
		...
		public List<DescribeScdnDomainTopUrlVisit_UrlList> Url300List
		{
			get
			{
				return url300List;
		...
		public List<DescribeScdnDomainTopUrlVisit_UrlList> Url400List
		{
			get
			{
				return url400List;
		...
		public List<DescribeScdnDomainTopUrlVisit_UrlList> Url500List
		{
			get
			{
				return url500List;
