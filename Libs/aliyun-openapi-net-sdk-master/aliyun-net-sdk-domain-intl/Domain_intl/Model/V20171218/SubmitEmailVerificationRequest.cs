...
namespace Aliyun.Acs.Domain_intl.Model.V20171218
{
    public class SubmitEmailVerificationRequest : RpcAcsRequest<SubmitEmailVerificationResponse>
    {
        public SubmitEmailVerificationRequest()
            : base("Domain-intl", "2017-12-18", "SubmitEmailVerification", "domain", "openAPI")
        {
        }
        ...
        public override SubmitEmailVerificationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
