...
namespace Aliyun.Acs.Domain_intl.Model.V20171218
{
    public class DeleteRegistrantProfileRequest : RpcAcsRequest<DeleteRegistrantProfileResponse>
    {
        public DeleteRegistrantProfileRequest()
            : base("Domain-intl", "2017-12-18", "DeleteRegistrantProfile", "domain", "openAPI")
        {
        }
        ...
        public override DeleteRegistrantProfileResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
