...
namespace Aliyun.Acs.Domain_intl.Model.V20171218
{
    public class QueryFailReasonForRegistrantProfileRealNameVerificationRequest : RpcAcsRequest<QueryFailReasonForRegistrantProfileRealNameVerificationResponse>
    {
        public QueryFailReasonForRegistrantProfileRealNameVerificationRequest()
            : base("Domain-intl", "2017-12-18", "QueryFailReasonForRegistrantProfileRealNameVerification", "domain", "openAPI")
        {
        }
        ...
        public override QueryFailReasonForRegistrantProfileRealNameVerificationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
