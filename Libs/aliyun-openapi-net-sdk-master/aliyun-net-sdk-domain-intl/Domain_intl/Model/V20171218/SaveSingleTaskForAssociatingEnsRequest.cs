...
namespace Aliyun.Acs.Domain_intl.Model.V20171218
{
    public class SaveSingleTaskForAssociatingEnsRequest : RpcAcsRequest<SaveSingleTaskForAssociatingEnsResponse>
    {
        public SaveSingleTaskForAssociatingEnsRequest()
            : base("Domain-intl", "2017-12-18", "SaveSingleTaskForAssociatingEns", "domain", "openAPI")
        {
        }
        ...
        public override SaveSingleTaskForAssociatingEnsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
