...
namespace Aliyun.Acs.Domain_intl.Model.V20171218
{
    public class LookupTmchNoticeRequest : RpcAcsRequest<LookupTmchNoticeResponse>
    {
        public LookupTmchNoticeRequest()
            : base("Domain-intl", "2017-12-18", "LookupTmchNotice", "domain", "openAPI")
        {
        }
        ...
        public override LookupTmchNoticeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
