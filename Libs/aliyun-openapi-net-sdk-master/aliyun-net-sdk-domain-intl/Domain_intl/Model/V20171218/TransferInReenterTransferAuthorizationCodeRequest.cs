...
namespace Aliyun.Acs.Domain_intl.Model.V20171218
{
    public class TransferInReenterTransferAuthorizationCodeRequest : RpcAcsRequest<TransferInReenterTransferAuthorizationCodeResponse>
    {
        public TransferInReenterTransferAuthorizationCodeRequest()
            : base("Domain-intl", "2017-12-18", "TransferInReenterTransferAuthorizationCode", "domain", "openAPI")
        {
        }
        ...
        public override TransferInReenterTransferAuthorizationCodeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return TransferInReenterTransferAuthorizationCodeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
