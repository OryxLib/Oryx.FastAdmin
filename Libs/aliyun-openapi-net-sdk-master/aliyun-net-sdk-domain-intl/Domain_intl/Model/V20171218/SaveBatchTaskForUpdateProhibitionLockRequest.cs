...
namespace Aliyun.Acs.Domain_intl.Model.V20171218
{
    public class SaveBatchTaskForUpdateProhibitionLockRequest : RpcAcsRequest<SaveBatchTaskForUpdateProhibitionLockResponse>
    {
        public SaveBatchTaskForUpdateProhibitionLockRequest()
            : base("Domain-intl", "2017-12-18", "SaveBatchTaskForUpdateProhibitionLock", "domain", "openAPI")
        {
        }
        ...
        public override SaveBatchTaskForUpdateProhibitionLockResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
