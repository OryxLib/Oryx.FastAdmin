...
namespace Aliyun.Acs.Domain_intl.Model.V20171218
{
    public class QueryTaskDetailListRequest : RpcAcsRequest<QueryTaskDetailListResponse>
    {
        public QueryTaskDetailListRequest()
            : base("Domain-intl", "2017-12-18", "QueryTaskDetailList", "domain", "openAPI")
        {
        }
        ...
        public override QueryTaskDetailListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
