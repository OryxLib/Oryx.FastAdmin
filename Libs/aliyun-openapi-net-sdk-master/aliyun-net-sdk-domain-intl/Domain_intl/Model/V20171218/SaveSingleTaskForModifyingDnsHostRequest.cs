...
namespace Aliyun.Acs.Domain_intl.Model.V20171218
{
    public class SaveSingleTaskForModifyingDnsHostRequest : RpcAcsRequest<SaveSingleTaskForModifyingDnsHostResponse>
    {
        public SaveSingleTaskForModifyingDnsHostRequest()
            : base("Domain-intl", "2017-12-18", "SaveSingleTaskForModifyingDnsHost", "domain", "openAPI")
        {
        }
        ...
        public override SaveSingleTaskForModifyingDnsHostResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
