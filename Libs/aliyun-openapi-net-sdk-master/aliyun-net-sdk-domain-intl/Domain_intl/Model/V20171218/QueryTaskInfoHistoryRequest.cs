...
namespace Aliyun.Acs.Domain_intl.Model.V20171218
{
    public class QueryTaskInfoHistoryRequest : RpcAcsRequest<QueryTaskInfoHistoryResponse>
    {
        public QueryTaskInfoHistoryRequest()
            : base("Domain-intl", "2017-12-18", "QueryTaskInfoHistory", "domain", "openAPI")
        {
        }
        ...
        public override QueryTaskInfoHistoryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
