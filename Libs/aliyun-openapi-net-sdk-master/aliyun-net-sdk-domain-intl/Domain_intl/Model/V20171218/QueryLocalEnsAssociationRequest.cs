...
namespace Aliyun.Acs.Domain_intl.Model.V20171218
{
    public class QueryLocalEnsAssociationRequest : RpcAcsRequest<QueryLocalEnsAssociationResponse>
    {
        public QueryLocalEnsAssociationRequest()
            : base("Domain-intl", "2017-12-18", "QueryLocalEnsAssociation", "domain", "openAPI")
        {
        }
        ...
        public override QueryLocalEnsAssociationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
