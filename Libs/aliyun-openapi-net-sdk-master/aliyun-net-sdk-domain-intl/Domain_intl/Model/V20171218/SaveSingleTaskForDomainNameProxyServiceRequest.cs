...
{
    public class SaveSingleTaskForDomainNameProxyServiceRequest : RpcAcsRequest<SaveSingleTaskForDomainNameProxyServiceResponse>
    {
        public SaveSingleTaskForDomainNameProxyServiceRequest()
            : base("Domain-intl", "2017-12-18", "SaveSingleTaskForDomainNameProxyService", "domain", "openAPI")
        {
        }
