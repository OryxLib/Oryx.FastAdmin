...
namespace Aliyun.Acs.Domain_intl.Model.V20171218
{
    public class SaveBatchTaskForUpdatingContactInfoByNewContactRequest : RpcAcsRequest<SaveBatchTaskForUpdatingContactInfoByNewContactResponse>
    {
        public SaveBatchTaskForUpdatingContactInfoByNewContactRequest()
            : base("Domain-intl", "2017-12-18", "SaveBatchTaskForUpdatingContactInfoByNewContact", "domain", "openAPI")
        {
        }
        ...
        public override SaveBatchTaskForUpdatingContactInfoByNewContactResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
