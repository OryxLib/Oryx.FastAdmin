...
{
    public class DescribePackagesRequest : RpcAcsRequest<DescribePackagesResponse>
    {
        public DescribePackagesRequest()
            : base("Yundun-ds", "2019-01-03", "DescribePackages", "sddp", "openAPI")
        {
        }
        ...
        public override DescribePackagesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePackagesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
