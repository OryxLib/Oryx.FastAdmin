...
{
    public class DescribeDataHubTopicsRequest : RpcAcsRequest<DescribeDataHubTopicsResponse>
    {
        public DescribeDataHubTopicsRequest()
            : base("Yundun-ds", "2019-01-03", "DescribeDataHubTopics", "sddp", "openAPI")
        {
        }
        ...
        public override DescribeDataHubTopicsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDataHubTopicsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
