...
{
    public class ModifyRuleStatusRequest : RpcAcsRequest<ModifyRuleStatusResponse>
    {
        public ModifyRuleStatusRequest()
            : base("Yundun-ds", "2019-01-03", "ModifyRuleStatus", "sddp", "openAPI")
        {
        }
        ...
        public override ModifyRuleStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyRuleStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
