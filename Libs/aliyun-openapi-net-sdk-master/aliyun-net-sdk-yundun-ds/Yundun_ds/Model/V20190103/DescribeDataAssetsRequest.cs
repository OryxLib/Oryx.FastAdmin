...
{
    public class DescribeDataAssetsRequest : RpcAcsRequest<DescribeDataAssetsResponse>
    {
        public DescribeDataAssetsRequest()
            : base("Yundun-ds", "2019-01-03", "DescribeDataAssets", "sddp", "openAPI")
        {
        }
        ...
        public override DescribeDataAssetsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDataAssetsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
