...
{
    public class DescribeEventCountsRequest : RpcAcsRequest<DescribeEventCountsResponse>
    {
        public DescribeEventCountsRequest()
            : base("Yundun-ds", "2019-01-03", "DescribeEventCounts", "sddp", "openAPI")
        {
        }
        ...
        public override DescribeEventCountsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeEventCountsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
