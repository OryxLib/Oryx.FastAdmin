...
namespace Aliyun.Acs.Domain.Model.V20180208
{
    public class RecordDemandRequest : RpcAcsRequest<RecordDemandResponse>
    {
        ...
        public override RecordDemandResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecordDemandResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
