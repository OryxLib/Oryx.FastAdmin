...
Process. $factory = function(){
    ...
    var worker = new Worker('../web_workers/multiprocessing.js')
...
Pool.map = function(){
   ...
   var $ns=$B.args('http://www.brython.info/src/libs/Pool.map', 3,
   ...
   for(var i=0; i < self.$processes; i++) {
       _workers[i] = new Worker('../web_workers/multiprocessing.js')
       var arg
