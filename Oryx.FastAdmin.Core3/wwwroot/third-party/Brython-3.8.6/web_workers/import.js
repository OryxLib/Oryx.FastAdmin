self.addEventListener('message', function (e) {
    ...
    importScripts('../brython_builtins.js', '../version_info.js',
        '../py2js.js',
        '../py_object.js', '../py_type.js', '../py_utils.js','../py_sort.js',
        '../py_builtin_functions.js', '../py_set.js',
        '../js_objects.js',
        '../py_import.js', '../py_int.js', '../py_float.js',
        '../py_complex.js',
        '../py_dict.js', '../py_list.js', '../py_string.js');
    ...
    import_module_search_path = function (module, origin) {
        ...
        if (!module.package_only) {
            ...
            // In this case, we don't have to search a file "http://www.brython.info/src/web_workers/X.py"
