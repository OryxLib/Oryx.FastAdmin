...
trans_menu = {
    ...
    "menu_demo": {"en": "Demo", "es": "Demo", "fr": "D茅mo"},
    "menu_gallery": {"en": "Gallery", "es": "Galer铆a", "fr": "Galerie"},
    "menu_doc": {"en": "Documentation", "es": "Documentaci贸n", "fr": "Documentation"},
    "menu_download": {"en": "Download", "es": "Descargas", "fr": "T茅l茅chargement"},
    "menu_dev": {"en": "Development", "es": "Desarrollo", "fr": "D茅veloppement"},
    "menu_groups": {"en": "Community", "es": "Comunidad", "fr": "Communaut茅"}
}
