...
var pkglist=['browser.widgets','collections','concurrent','concurrent.futures','email','https://brython.info/src/email.mime','encodings','html','http','importlib','json','logging','multiprocessing','multiprocessing.dummy','pydoc_data','site-packages.simpleaio','https://brython.info/src/site-packages.ui','test','test.encoded_modules','test.leakers','https://brython.info/src/test.namespace_pkgs.not_a_namespace_pkg.foo','test.support','test.test_email','test.test_importlib','test.test_importlib.builtin','test.test_importlib.extension','test.test_importlib.frozen','test.test_importlib.import_','test.test_importlib.source','test.test_json','test.tracedmodules','unittest','https://brython.info/src/unittest.test','unittest.test.testmock','urllib']
...
((ext=="py")? "Lib/" :"libs/")+
fullname.replace(/\./g,"/"),metadata={ext:ext,is_package:is_pkg,path:path+(is_pkg? "https://brython.info/__init__.py" :
...
return self
case-0:
return "https://brython.info/src/-0x0.0p0"
case 0:
return "https://brython.info/src/0x0.0p0"}
...
return res}
str.find=function(){
var $=$B.args("https://brython.info/src/str.find",4,{self:null,sub:null,start:null,end:null},["self","sub","start","end"],arguments,{start:0,end:null},null,null)
check_str($.sub)
normalize_start_end($)
...
modules['https://brython.info/src/browser.html']=(function($B){var _b_=$B.builtins
var TagSum=$B.TagSum
function makeTagDict(tagName){
var dict={__class__:_b_.type,$infos:{__name__:tagName,__module__:"https://brython.info/src/browser.html"}}
...
try{
arg=$B.imported["https://brython.info/src/browser.html"].
...
res.__dict__=_b_.dict.$factory()
return res}
$B.set_func_names(dict,"https://brython.info/src/browser.html")
return dict}
...
if(!($B.isWebWorker ||$B.isNode)){modules['browser'].html=modules['https://brython.info/src/browser.html']}
var _b_=$B.builtins
