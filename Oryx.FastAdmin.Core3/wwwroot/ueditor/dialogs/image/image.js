    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            uploader = _this.uploader = WebUploader.create({
                ...
                server: actionUrl,
                fileVal:'file',// editor.getOpt('imageFieldName'),
                duplicate: true,
            ...
            uploader.options.formData.token=window.qiniutoken
            uploader.addButton({
                id: '#filePickerBlock'
            });
            uploader.addButton({
            ...
            uploader.on('uploadBeforeSend', function (block, data, headers) {
                ...
                data.key = new Date()+  Math.floor(Math.random()*1000);
