    ...
    UploadFile.prototype = {
        ...
        initUploader: function () {
            ...
            uploader = _this.uploader = WebUploader.create({
                ...
                formData: {
                    token: window.top.qiniutoken
                },
                swf: '../../third-party/webuploader/Uploader.swf',
                server: actionUrl,
                fileVal: 'file', //editor.getOpt('videoFieldName'),
                duplicate: true,
            ...
            uploader.on('uploadBeforeSend', function (file, data, header) {
                data.key = new Date() - 0 + Math.floor(Math.random() * 1000) + '.' + file.file.ext;
                ...
                try {
                    ...
                    if (json.key) {
                        uploadVideoList.push({
                            'url': 'https://mioto.milbit.com/' + json.key,
                            'type': file.type,
                            'original': 'pagetechs' //json.original
                        });
                        $file.append('<span class="success"></span>');
                    } else {
                        $file.find('.error').text('error ').show();
                    }
                } catch (e) {
