...
const reducer = function (state, action) {
    ...
    console.log('project state - reducer')
    ...
    case START_MANUAL_UPDATING:
        if (state.loadingState === LoadingState.SHOWING_WITH_ID||true) {
            return Object.assign({}, state, {
                loadingState: LoadingState.MANUAL_UPDATING
            });
        }
...
const doneCreatingProject = (id, loadingState) => {
    console.log('project state - doneCreatingProject')
...
const onFetchedProjectData = (projectData, loadingState) => {
    console.log('project state - onFetchedProjectData')
    console.log('%c '+loadingState,"color:#F00")
    switch (loadingState) {
...
const onLoadedProject = (loadingState, canSave, success) => {
    console.log('project state - onLoadedProject')
    if (success) {
        switch (loadingState) {
...
const doneUpdatingProject = loadingState => {
    console.log('project state - doneUpdatingProject')
    switch (loadingState) {
...
const setProjectId = id => {
    console.log('%c===========set project===============','color:#f00')
    console.log(id)
    return {
        type: SET_PROJECT_ID,
        projectId: id
...
const requestNewProject = needSave => {
    ...
    console.log('project state - requestNewProject')

    return {type: START_FETCHING_NEW};
};

const requestProjectUpload = loadingState => {
    console.log('project state - requestProjectUpload')
    switch (loadingState) {
