...
/* harmony import */ var xhr__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! xhr */ "./node_modules/xhr/index.js");
/* harmony import */ var xhr__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(xhr__WEBPACK_IMPORTED_MODULE_8__);
...
var handleSave = function handleSave() {
  Object(_lib_log_js__WEBPACK_IMPORTED_MODULE_7__["default"])('Handle Save !');
};

var handleThumbnail = function handleThumbnail(id, data, blob) {
  console.log('handleThumbnail');
  console.log(id);
  console.log(data);
  var fileName = 'thumb/' + id + '.jpg';
  xhr__WEBPACK_IMPORTED_MODULE_8___default()({
    url: "/QiniuFile/TokenByKey?fileName=" + fileName
  }, function (err, res) {
    var token = res.body;
...
var handleEdit = function handleEdit(res) {
  console.log('handleEdit');
  console.log(res);
  xhr__WEBPACK_IMPORTED_MODULE_8___default()({}, function (err, res) {});
};
/*
...
/* harmony default export */ __webpack_exports__["default"] = (function (appTarget) {
  ...
  var WrappedGui = Object(redux__WEBPACK_IMPORTED_MODULE_2__["compose"])(_lib_app_state_hoc_jsx__WEBPACK_IMPORTED_MODULE_3__["default"], _lib_hash_parser_hoc_jsx__WEBPACK_IMPORTED_MODULE_5__["default"], _lib_titled_hoc_jsx__WEBPACK_IMPORTED_MODULE_6__["default"])(_containers_gui_jsx__WEBPACK_IMPORTED_MODULE_4__["default"]);
  console.log("WrappedGui");
  console.log(WrappedGui); // TODO a hack for testing the backpack, allow backpack host to be set by url param
  ...
  var projectId = routes[routes.length - 1]; //routes.length >= 4 ? window.location.href.split('/')[4] : "0";

  projectId = projectId || 'd7502cee-0712-4ae2-bd8d-93b8eab0a694';
  console.log('projectId');
  console.log(projectId);
  var playModel = window.location.hash.toLowerCase().indexOf('play') > -1 || window.location.href.toLowerCase().indexOf('preview') > -1;
